/*!
 * You are currently viewing the RealistikOsu! JavaScript source code.
 * Just so you know: if you want to see the source of the RealistikOsu! Frontend
 * (Hanayo), you can do so at https://github.com/RealistikOsu/hanayo
...
function showMessage(e, t) {
    var n = $('<div class="ui ' + e + ' message hidden"><i class="close icon"></i>' + T(t) + "</div>");
    n.find(".close.icon").click(closeClosestMessage), $("#messages-container").append(n), n.slideDown(300)
}

function _api(e, t, n, i, o, r, a) {
    "function" == typeof n && (i = n, n = null), "boolean" == typeof o && (r = o, o = void 0), a = void 0 !== typeof a && a;
    var s = "An error occurred while contacting the Fuquila API. Please report this to a Fuquila developer.";
    $.ajax({
        method: r ? "POST" : "GET",
        dataType: "json",
        url: e + t,
        data: r ? JSON.stringify(n) : n,
        contentType: r ? "application/json; charset=utf-8" : "",
        success: function(e) {
            if (200 != e.code) {
                if ("function" == typeof o && (a || e.code >= 400 && e.code < 500)) return void o(e);
                console.warn(e), showMessage("error", s)
            }
            i(e)
        },
        error: function(e, t, n) {
            if ("function" == typeof o && (a || e.status >= 400 && e.status < 500)) return void o(e.responseJSON);
            console.warn(e, t, n), showMessage("error", s)
        }
    })
}

function api(e, t, n, i, o, r) {
    return _api(hanayoConf.baseAPI + "/api/v1/", e, t, n, i, o, r)
}

function banchoAPI(e, t, n, i, o, r) {
    return void 0 === i && (r = !0, i = function(e) {
    }), _api(hanayoConf.banchoAPI + "/api/v2/", e, t, n, i, o, r)
}
...
function setupSimplepag(e) {
    var t = $(".simplepag");
    t.find(".left.floated .item").click(function() {
        if ($(this).hasClass("disabled")) return !1;
        page--, e()
    }), t.find(".right.floated .item").click(function() {
        if ($(this).hasClass("disabled")) return !1;
        page++, e()
    })
}

function disableSimplepagButtons(e) {
    var t = $(".simplepag");
    page <= 1 ? t.find(".left.floated .item").addClass("disabled") : t.find(".left.floated .item").removeClass("disabled"), e ? t.find(".right.floated .item").addClass("disabled") : t.find(".right.floated .item").removeClass("disabled")
}
...
function timeFormat(e) {
    ...
    var n = Math.floor(e / 60),
        i = e % 60,
        o = "";
    return t > 0 ? (o += t + ":", n < 10 && (o += "0"), o += n + ":") : o += n + ":", i < 10 && (o += "0"), o += i
}
...
function formToObject(e) {
    var t = e.find("input, textarea, select"),
        n = {};
    return t.each(function(e, t) {
        if (t = $(t), void 0 !== t.attr("name")) {
            var i, o = t.attr("name").split(".");
            switch (t.attr("type")) {
                case "checkbox":
                    i = t.is(":checked");
                    break;
            ...
            n = modifyObjectDynamically(n, o, i)
        }
    }), n
}

function modifyObjectDynamically(e, t, n) {
    return 1 === t.length ? e[t[0]] = n : t.length > 1 && ("object" != typeof e[t[0]] && (e[t[0]] = {}), e[t[0]] = modifyObjectDynamically(e[t[0]], t.slice(1), n)), e
}

function T(e, t) {
    return void 0 !== t && void 0 !== t.count && -1 === $.inArray(hanayoConf.language, langWhitelist) && 1 !== t.count && (e = keyPlurals[e]), i18next.t(e, t)
}

function privilegesToString(e) {
    var t = [];
    return apiPrivileges.forEach(function(n, i) {
        0 != (e & 1 << i + 1) && t.push(n)
    }), t.join(", ")
}
...
function isLoggedIn() {
    ...
    function n(e, t, n) {
        ...
        if (r.text = e, t)
            for (i in fe)(o = t[i] || t.getAttribute && t.getAttribute(i)) && r.setAttribute(i, o);
    ...
    function d() {
        Y.removeEventListener("DOMContentLoaded", d), e.removeEventListener("load", d), ge.ready()
    }
    ...
    function p(e) {
        return e.replace(De, "ms-").replace(Re, f)
    }
    ...
    function m(e, t, n, i) {
        var o, r, a = 20,
            ...
            u = e.nodeType && (ge.cssNumber[t] || "px" !== c && +l) && Me.exec(ge.css(e, t));
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; a--;) ge.style(e, t, u + c), (1 - r) * (1 - (r = s() / l || .5)) <= 0 && (a = 0), u /= r;
            u *= 2, ge.style(e, t, u + c), n = n || []
        }
        return n && (u = +u || +l || 0, o = n[1] ? u + (n[1] + 1) * n[2] : +n[2], i && (i.unit = c, i.start = u, i.end = o)), o
    }

    function v(e, t) {
        for (var n, i, o, r, a, s, l, c = [], u = 0, d = e.length; u < d; u++)(i = e[u]).style && (n = i.style.display, t ? ("none" === n && (c[u] = Pe.get(i, "display") || null, c[u] || (i.style.display = "")), "" === i.style.display && Ue(i) && (c[u] = (l = a = r = void 0, a = (o = i).ownerDocument, s = o.nodeName, (l = We[s]) || (r = a.body.appendChild(a.createElement(s)), l = ge.css(r, "display"), r.parentNode.removeChild(r), "none" === l && (l = "block"), We[s] = l)))) : "none" !== n && (c[u] = "none", Pe.set(i, "display", n)));
    ...
    function x(e, t, n, o, r) {
        for (var a, s, l, c, u, d, f = t.createDocumentFragment(), p = [], g = 0, h = e.length; g < h; g++)
            if ((a = e[g]) || 0 === a)
                if ("object" === i(a)) ge.merge(p, a.nodeType ? [a] : a);
                else if (Ge.test(a)) {
            for (s = s || f.appendChild(t.createElement("div")), l = (Be.exec(a) || ["", ""])[1].toLowerCase(), c = Ke[l] || Ke._default, s.innerHTML = c[1] + ge.htmlPrefilter(a) + c[2], d = c[0]; d--;) s = s.lastChild;
            ge.merge(p, s.childNodes), (s = f.firstChild).textContent = ""
        } else p.push(t.createTextNode(a));
        for (f.textContent = "", g = 0; a = p[g++];)
            if (o && -1 < ge.inArray(a, o)) r && r.push(a);
            else if (u = $e(a), s = b(f.appendChild(a), "script"), u && y(s), n)
    ...
    function T(e, t, n, i, o, r) {
        var a, s;
        if ("object" == typeof t) {
            for (s in "string" != typeof n && (i = i || n, n = void 0), t) T(e, s, n, i, t[s], r);
            return e
        }
    ...
    function S(e, t, n) {
        n ? (Pe.set(e, t, !1), ge.event.add(e, t, {
            namespace: !1,
            handler: function(e) {
                var i, o, r = Pe.get(this, t);
                if (1 & e.isTrigger && this[t]) {
                    if (r.length)(ge.event.special[t] || {}).delegateType && e.stopPropagation();
                    else if (r = ee.call(arguments), Pe.set(this, t, r), i = n(this, t), this[t](), r !== (o = Pe.get(this, t)) || i ? Pe.set(this, t, !1) : o = {}, r !== o) return e.stopImmediatePropagation(), e.preventDefault(), o.value
                } else r.length && (Pe.set(this, t, {
                    value: ge.event.trigger(ge.extend(r[0], ge.Event.prototype), r.slice(1), this)
                }), e.stopImmediatePropagation())
            }
        })) : void 0 === Pe.get(e, t) && ge.event.add(e, t, w)
    }

    function A(e, t) {
        return r(e, "table") && r(11 !== t.nodeType ? t : t.firstChild, "tr") && ge(e).children("tbody")[0] || e
    }
    ...
    function D(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Le.hasData(e) && (s = Le.access(e), l = ge.extend({}, s), Le.set(t, l))
        }
    }
    ...
    function R(e, t, i, o) {
        ...
        var r, a, s, l, c, u, d = 0,
            ...
            g = t[0],
            h = ue(g);
        if (h || 1 < f && "string" == typeof g && !ce.checkClone && it.test(g)) return e.each(function(n) {
            var r = e.eq(n);
            h && (t[0] = g.call(this, n, r.html())), R(r, t, i, o)
        });
        if (f && (a = (r = x(t, e[0].ownerDocument, !1, e, o)).firstChild, 1 === r.childNodes.length && (r = a), a || o)) {
            for (l = (s = ge.map(b(r, "script"), E)).length; d < f; d++) c = r, d !== p && (c = ge.clone(c, !0, !0), l && ge.merge(s, b(c, "script"))), i.call(e[d], c, d);
            if (l)
                for (u = s[s.length - 1].ownerDocument, ge.map(s, j), d = 0; d < l; d++) c = s[d], Xe.test(c.type || "") && !Pe.access(c, "globalEval") && ge.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? ge._evalUrl && !c.noModule && ge._evalUrl(c.src, {
    ...
    function O(e, t, n) {
        for (var i, o = t ? ge.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || ge.cleanData(b(i)), i.parentNode && (n && $e(i) && y(b(i, "script")), i.parentNode.removeChild(i));
        return e
    }

    function P(e, t, n) {
        var i, o, r, a, s = e.style;
        return (n = n || at(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || $e(e) || (a = ge.style(e, t)), !ce.pixelBoxStyles() && rt.test(a) && st.test(t) && (i = s.width, o = s.minWidth, r = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = i, s.minWidth = o, s.maxWidth = r)), void 0 !== a ? a + "" : a
    }
    ...
    function q(e) {
        return ge.cssProps[e] || ut[e] || (e in ct ? e : ut[e] = function(e) {
    ...
    function F(e, t, n, i, o, r) {
        ...
        for (; a < 4; a += 2) "margin" === n && (l += ge.css(e, n + Ie[a], !0, o)), i ? ("content" === n && (l -= ge.css(e, "padding" + Ie[a], !0, o)), "margin" !== n && (l -= ge.css(e, "border" + Ie[a] + "Width", !0, o))) : (l += ge.css(e, "padding" + Ie[a], !0, o), "padding" !== n ? l += ge.css(e, "border" + Ie[a] + "Width", !0, o) : s += ge.css(e, "border" + Ie[a] + "Width", !0, o));
    ...
    function M(e, t, n) {
        ...
        return (!ce.boxSizingReliable() && o || "auto" === a || !parseFloat(a) && "inline" === ge.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === ge.css(e, "boxSizing", !1, i), (r = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + F(e, t, n || (o ? "border" : "content"), r, i, a) + "px"
    }
    ...
    function H() {
        mt && (!1 === Y.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(H) : e.setTimeout(H, ge.fx.interval), ge.fx.tick())
    }
    ...
    function U(e, t, n) {
        for (var i, o = (V.tweeners[t] || []).concat(V.tweeners["*"]), r = 0, a = o.length; r < a; r++)
    ...
    function V(e, t, n) {
        var i, o, r = 0,
            ...
            l = function() {
                if (o) return !1;
                for (var t = ht || $(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, a = c.tweens.length; r < a; r++) c.tweens[r].run(i);
        ...
        for ((! function(e, t) {
                var n, i, o, r, a;
                for (n in e)
                    if (o = t[i = p(n)], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (a = ge.cssHooks[i]) && "expand" in a)
                        for (n in r = a.expand(r), delete e[i], r) n in e || (e[n] = r[n], t[n] = o);
                    else t[i] = o
            }(u, c.opts.specialEasing)); r < a; r++)
            if (i = V.prefilters[r].call(c, e, u, c.opts)) return ue(i.stop) && (ge._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return ge.map(u, U, c), ue(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), ge.fx.timer(ge.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    ge.fn = ge.prototype = {
        ...
        var e, t, n, i, o, r, a = arguments[0] || {},
            ...
            l = arguments.length,
            c = !1;
        for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || ue(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
            if (null != (e = arguments[s]))
                for (t in e) i = e[t], "__proto__" !== t && a !== i && (c && i && (ge.isPlainObject(i) || (o = Array.isArray(i))) ? (n = a[t], r = o && !Array.isArray(n) ? [] : o || ge.isPlainObject(n) ? n : {}, o = !1, a[t] = ge.extend(c, r, i)) : void 0 !== i && (a[t] = i));
        return a
    }, ge.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== re.call(e) || (t = Z(e)) && ("function" != typeof(n = ae.call(t, "constructor") && t.constructor) || se.call(n) !== le))
        },
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (o(Object(e)) ? ge.merge(n, "string" == typeof e ? [e] : e) : ne.call(n, e)), n
        },
        ...
        guid: 1,
        support: ce
    }), "function" == typeof Symbol && (ge.fn[Symbol.iterator] = G[Symbol.iterator]), ge.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function(e, t) {
    ...
    var me = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : M) !== D && j(t), t = t || D, O)) {
                if (11 !== g && (l = he.exec(e)))
                    if (o = l[1]) {
                        if (9 === g) {
                    ...
                    if (f = e, p = t, 1 === g && se.test(e)) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(ye, xe) : t.setAttribute("id", s = F), r = (u = C(e)).length; r--;) u[r] = "#" + s + " " + d(u[r]);
        ...
        function f(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (l) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || a)
                            if (u = (d = t[F] || (t[F] = {}))[t.uniqueID] || (d[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[i] || t;
                            else {
                                if ((c = u[r]) && c[0] === I && c[1] === s) return f[2] = c[2];
        ...
        function h(e, n, o, r, a, s) {
            return r && !r[F] && (r = h(r)), a && !a[F] && (a = h(a, s)), i(function(i, s, l, c) {
                var u, d, f, p = [],
                    h = [],
                    m = s.length,
                    v = i || function(e, n, i) {
                    ...
                    b = !e || !i && n ? v : g(v, p, e, l, c),
                    y = o ? a || (i ? e : m || r) ? [] : s : b;
                if (o && o(b, y, l, c), r)
                    for (u = g(y, h), r(u, [], l, c), d = u.length; d--;)(f = u[d]) && (y[h[d]] = !(b[h[d]] = f));
                if (i) {
                    if (a || e) {
                        if (a) {
                            for (u = [], d = y.length; d--;)(f = y[d]) && u.push(b[d] = f);
                            a(null, y = [], u, c)
                        }
                        for (d = y.length; d--;)(f = y[d]) && -1 < (u = a ? G(i, f) : p[d]) && (i[u] = !(s[u] = f))
                    }
                } else y = g(y === s ? y.splice(m, y.length) : y), a ? a(null, s, y, c) : Q.apply(s, y)
            })
        }

        function m(e) {
            for (var t, n, i, o = e.length, r = y.relative[e[0].type], a = r || y.relative[" "], s = r ? 1 : 0, l = f(function(e) {
                    return e === t
                }, a, !0), c = f(function(e) {
                    return -1 < G(t, e)
                ...
                if (n = y.relative[e[s].type]) u = [f(p(u), n)];
                else {
                    if ((n = y.filter[e[s].type].apply(null, e[s].matches))[F]) {
                        for (i = ++s; i < o && !y.relative[e[i].type]; i++);
                        return h(1 < s && p(u), 1 < s && d(e.slice(0, s - 1).concat({
                            value: " " === e[s - 2].type ? "*" : ""
                        })).replace(oe, "$1"), n, s < i && m(e.slice(s, i)), i < o && m(e = e.slice(i)), i < o && d(e))
                    }
                    u.push(n)
                } return p(u)
        }
        var v, b, y, x, w, C, k, T, S, A, E, j, D, R, O, P, L, q, N, F = "sizzle" + 1 * new Date,
            M = e.document,
            I = 0,
            H = 0,
            $ = n(),
        ...
        try {
            Q.apply(B = J.call(M.childNodes), M.childNodes), B[M.childNodes.length].nodeType
        } catch (v) {
            Q = {
        ...
        for (v in b = t.support = {}, w = t.isXML = function(e) {
                var t = e.namespaceURI,
                    n = (e.ownerDocument || e).documentElement;
                return !de.test(t || n && n.nodeName || "HTML")
            }, j = t.setDocument = function(e) {
                var t, n, i = e ? e.ownerDocument || e : M;
                return i !== D && 9 === i.nodeType && i.documentElement && (R = (D = i).documentElement, O = !w(D), M !== D && (n = D.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), b.attributes = o(function(e) {
                    return e.className = "i", !e.getAttribute("className")
                }), b.getElementsByTagName = o(function(e) {
                    return e.appendChild(D.createComment("")), !e.getElementsByTagName("*").length
                }), b.getElementsByClassName = ge.test(D.getElementsByClassName), b.getById = o(function(e) {
                    return R.appendChild(e).id = F, !D.getElementsByName || !D.getElementsByName(F).length
                ...
                }, L = [], P = [], (b.qsa = ge.test(D.querySelectorAll)) && (o(function(e) {
                    ...
                    t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && P.push("name" + Z + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && P.push(":enabled", ":disabled"), R.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && P.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), P.push(",.*:")
                })), (b.matchesSelector = ge.test(q = R.matches || R.webkitMatchesSelector || R.mozMatchesSelector || R.oMatchesSelector || R.msMatchesSelector)) && o(function(e) {
                    b.disconnectedMatch = q.call(e, "*"), q.call(e, "[s!='']:x"), L.push("!=", ne)
                }), P = P.length && new RegExp(P.join("|")), L = L.length && new RegExp(L.join("|")), t = ge.test(R.compareDocumentPosition), N = t || ge.test(R.contains) ? function(e, t) {
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === D || e.ownerDocument === M && N(M, e) ? -1 : t === D || t.ownerDocument === M && N(M, t) ? 1 : A ? G(A, e) - G(A, t) : 0 : 4 & n ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return E = !0, 0;
                    var n, i = 0,
                        o = e.parentNode,
                        ...
                        s = [e],
                        l = [t];
                    if (!o || !r) return e === D ? -1 : t === D ? 1 : o ? -1 : r ? 1 : A ? G(A, e) - G(A, t) : 0;
                    if (o === r) return a(e, t);
                ...
                if ((e.ownerDocument || e) !== D && j(e), b.matchesSelector && O && !V[n + " "] && (!L || !L.test(n)) && (!P || !P.test(n))) try {
                    var i = q.call(e, n);
                ...
                return (e.ownerDocument || e) !== D && j(e), N(e, t)
            }, t.attr = function(e, t) {
                (e.ownerDocument || e) !== D && j(e);
                var n = y.attrHandle[t.toLowerCase()],
                    i = n && _.call(y.attrHandle, t.toLowerCase()) ? n(e, t, !O) : void 0;
                ...
                var t, n = [],
                    i = 0,
                    o = 0;
                if (E = !b.detectDuplicates, A = !b.sortStable && e.slice(0), e.sort(W), E) {
                ...
                filter: {
                    ...
                    CHILD: function(e, t, n, i, o) {
                        ...
                        return 1 === i && 0 === o ? function(e) {
                            ...
                            var c, u, d, f, p, g, h = r !== a ? "nextSibling" : "previousSibling",
                                m = t.parentNode,
                            ...
                            if (m) {
                                ...
                                if (g = [a ? m.firstChild : m.lastChild], a && b) {
                                    for (y = (p = (c = (u = (d = (f = m)[F] || (f[F] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === I && c[1]) && c[2], f = p && m.childNodes[p]; f = ++p && f && f[h] || (y = p = 0) || g.pop();)
                                        if (1 === f.nodeType && ++y && f === t) {
                                            u[e] = [I, p, y];
                                            break
                                        }
                                } else if (b && (y = p = (c = (u = (d = (f = t)[F] || (f[F] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === I && c[1]), !1 === y)
                                    for (;
                                        (f = ++p && f && f[h] || (y = p = 0) || g.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++y || (b && ((u = (d = f[F] || (f[F] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [I, y]), f !== t)););
                    ...
                    PSEUDO: function(e, n) {
                        ...
                        return r[F] ? r(n) : 1 < r.length ? (o = [e, e, "", n], y.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function(e, t) {
                            for (var i, o = r(e, n), a = o.length; a--;) e[i = G(e, o[a])] = !(t[i] = o[a])
                        }) : function(e) {
                            return r(e, 0, o)
                        }) : r
                    }
                ...
                pseudos: {
                    ...
                    lang: i(function(e) {
                        return ce.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(ve, be).toLowerCase(),
                            function(t) {
                                var n;
                                do {
        ...
        return u.prototype = y.filters = y.pseudos, y.setFilters = new u, C = t.tokenize = function(e, n) {
            var i, o, r, a, s, l, c, u = z[e + " "];
            if (u) return n ? 0 : u.slice(0);
            for (s = e, l = [], c = y.preFilter; s;) {
                for (a in i && !(o = re.exec(s)) || (o && (s = s.slice(o[0].length) || s), l.push(r = [])), i = !1, (o = ae.exec(s)) && (i = o.shift(), r.push({
                        value: i,
                        type: o[0].replace(oe, " ")
                    }), s = s.slice(i.length)), y.filter) !(o = ue[a].exec(s)) || c[a] && !(o = c[a](o)) || (i = o.shift(), r.push({
                    value: i,
                    type: a,
                    matches: o
                }), s = s.slice(i.length));
            ...
            var o, r, a, s, l, c, u = [],
                ...
                f = U[e + " "];
            if (!f) {
                for (n || (n = C(e)), o = n.length; o--;)(f = m(n[o]))[F] ? u.push(f) : d.push(f);
                (f = U(e, (r = d, s = 0 < (a = u).length, l = 0 < r.length, c = function(e, n, i, o, c) {
                    var u, d, f, p = 0,
                        h = "0",
                        m = e && [],
                        v = [],
                        b = S,
                        x = e || l && y.find.TAG("*", c),
                        w = I += null == b ? 1 : Math.random() || .1,
                        C = x.length;
                    for (c && (S = n === D || n || c); h !== C && null != (u = x[h]); h++) {
                        if (l && u) {
                            for (d = 0, n || u.ownerDocument === D || (j(u), i = !O); f = r[d++];)
                                if (f(u, n || D, i)) {
                                    o.push(u);
                                    break
                                } c && (I = w)
                        }
                        s && ((u = !f && u) && p--, e && m.push(u))
                    }
                    if (p += h, s && h !== p) {
                        for (d = 0; f = a[d++];) f(m, v, n, i);
                        if (e) {
                            if (0 < p)
                                for (; h--;) m[h] || v[h] || (v[h] = X.call(o));
                            v = g(v)
                        }
                        Q.apply(o, v), c && !e && 0 < v.length && 1 < p + a.length && t.uniqueSort(o)
                    }
                    return c && (I = w, S = b), m
                }, s ? i(c) : c))).selector = e
            }
            ...
            if (n = n || [], 1 === f.length) {
                if (2 < (r = f[0] = f[0].slice(0)).length && "ID" === (a = r[0]).type && 9 === t.nodeType && O && y.relative[r[1].type]) {
                    if (!(t = (y.find.ID(a.matches[0].replace(ve, be), t) || [])[0])) return n;
                    u && (t = t.parentNode), e = e.slice(r.shift().value.length)
                }
                for (o = ue.needsContext.test(e) ? 0 : r.length; o-- && (a = r[o], !y.relative[s = a.type]);)
                    if ((l = y.find[s]) && (i = l(a.matches[0].replace(ve, be), me.test(r[0].type) && c(t.parentNode) || t))) {
                        if (r.splice(o, 1), !(e = i.length && d(r))) return Q.apply(n, i), n;
                        break
                    }
            }
            return (u || k(e, f))(i, t, !O, n, !t || me.test(e) && c(t.parentNode) || t), n
        }, b.sortStable = F.split("").sort(W).join("") === F, b.detectDuplicates = !!E, j(), b.sortDetached = o(function(e) {
    ...
    ge.filter = function(e, t, n) {
        ...
        is: function(e) {
            return !!a(this, "string" == typeof e && ye.test(e) ? ge(e) : e || [], !1).length
        }
    });
    var we, Ce = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (ge.fn.init = function(e, t, n) {
        ...
        if (n = n || we, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof ge ? t[0] : t, ge.merge(this, ge.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : Y, !0)), xe.test(i[1]) && ge.isPlainObject(t))
    ...
    ge.fn.extend({
        ...
        index: function(e) {
            return e ? "string" == typeof e ? ie.call(ge(e), this[0]) : ie.call(this, e.jquery ? e[0] : e) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
        },
        add: function(e, t) {
        ...
        contents: function(e) {
            return void 0 !== e.contentDocument ? e.contentDocument : (r(e, "template") && (e = e.content || e), ge.merge([], e.childNodes))
        }
    }, function(e, t) {
        ge.fn[e] = function(n, i) {
            var o = ge.map(this, t, n);
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = ge.filter(i, o)), 1 < this.length && (Te[e] || ge.uniqueSort(o), ke.test(e) && o.reverse()), this.pushStack(o)
        }
    });
    var Se = /[^\x20\t\r\n\f]+/g;
    ge.Callbacks = function(e) {
        ...
        var o, r, a, s, l = [],
            ...
            u = -1,
            d = function() {
                for (s = s || e.once, a = o = !0; c.length; u = -1)
                    for (r = c.shift(); ++u < l.length;) !1 === l[u].apply(r[0], r[1]) && e.stopOnFalse && (u = l.length, r = !1);
            ...
            f = {
                add: function() {
                    return l && (r && !o && (u = l.length - 1, c.push(r)), function t(n) {
                        ge.each(n, function(n, o) {
                            ue(o) ? e.unique && f.has(o) || l.push(o) : o && o.length && "string" !== i(o) && t(o)
                        })
                    }(arguments), r && !o && d()), this
                },
                remove: function() {
                    return ge.each(arguments, function(e, t) {
                        for (var n; - 1 < (n = ge.inArray(t, l, n));) l.splice(n, 1), n <= u && u--
                    }), this
                },
                has: function(e) {
                    return e ? -1 < ge.inArray(e, l) : 0 < l.length
                },
                empty: function() {
                    return l && (l = []), this
                },
                ...
                fireWith: function(e, t) {
                    return s || (t = [e, (t = t || []).slice ? t.slice() : t], c.push(t), o || d()), this
                },
                fire: function() {
                ...
                o = {
                    ...
                    then: function(t, i, o) {
                                ...
                                var s = this,
                                    ...
                                    d = function() {
                                        ...
                                        if (!(t < a)) {
                                            ...
                                            d = e && ("object" == typeof e || "function" == typeof e) && e.then, ue(d) ? o ? d.call(e, r(a, n, l, o), r(a, n, c, o)) : (a++, d.call(e, r(a, n, l, o), r(a, n, c, o), r(a, n, l, n.notifyWith))) : (i !== l && (s = void 0, u = [e]), (o || n.resolveWith)(s, u))
                                        }
                                    },
                                    f = o ? d : function() {
                                        try {
                                            ...
                                            ge.Deferred.exceptionHook && ge.Deferred.exceptionHook(e, f.stackTrace), a <= t + 1 && (i !== c && (s = void 0, u = [e]), n.rejectWith(s, u))
                                        }
                                    };
                        ...
                        return ge.Deferred(function(e) {
                            n[0][3].add(r(0, e, ue(o) ? o : l, e.notifyWith)), n[1][3].add(r(0, e, ue(t) ? t : l)), n[2][3].add(r(0, e, ue(i) ? i : c))
                        }).promise()
                    },
                    promise: function(e) {
        ...
        when: function(e) {
            ...
            if (t <= 1 && (u(e, r.done(a(n)).resolve, r.reject, !t), "pending" === r.state() || ue(o[n] && o[n].then))) return r.then();
    ...
    ge.fn.ready = function(e) {
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --ge.readyWait : ge.isReady) || (ge.isReady = !0) !== e && 0 < --ge.readyWait || Ee.resolveWith(Y, [ge])
        }
    }), ge.ready.then = Ee.then, "complete" === Y.readyState || "loading" !== Y.readyState && !Y.documentElement.doScroll ? e.setTimeout(ge.ready) : (Y.addEventListener("DOMContentLoaded", d), e.addEventListener("load", d));
    var je = function(e, t, n, o, r, a, s) {
            var l = 0,
                c = e.length,
                u = null == n;
            if ("object" === i(n))
                for (l in r = !0, n) je(e, t, l, n[l], !0, a, s);
            else if (void 0 !== o && (r = !0, ue(o) || (s = !0), u && (s ? (t.call(e, o), t = null) : (u = t, t = function(e, t, n) {
    ...
    g.uid = 1, g.prototype = {
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== i) {
                if (void 0 !== t) {
                    n = (t = Array.isArray(t) ? t.map(p) : (t = p(t)) in i ? [t] : t.match(Se) || []).length;
                    for (; n--;) delete i[t[n]]
    ...
    ge.extend({
        ...
        data: function(e, t) {
            var n, i, o, r = this[0],
                a = r && r.attributes;
            if (void 0 === e) {
                if (this.length && (o = Le.get(r), 1 === r.nodeType && !Pe.get(r, "hasDataAttrs"))) {
                    for (n = a.length; n--;) a[n] && 0 === (i = a[n].name).indexOf("data-") && (i = p(i.slice(5)), h(r, i, o[i]));
            ...
            return "object" == typeof e ? this.each(function() {
                ...
                var n;
                if (r && void 0 === t) return void 0 !== (n = Le.get(r, e)) ? n : void 0 !== (n = h(r, e)) ? n : void 0;
                this.each(function() {
                    Le.set(this, e, t)
                })
    ...
    He.getRootNode && ($e = function(e) {
        return ge.contains(e.ownerDocument, e) || e.getRootNode(ze) === e.ownerDocument
    });
    var Ue = function(e, t) {
            return "none" === (e = t || e).style.display || "" === e.style.display && $e(e) && "none" === ge.css(e, "display")
        },
        Ve = function(e, t, n, i) {
            var o, r, a = {};
    ...
    ge.event = {
        ...
        add: function(e, t, n, i, o) {
            var r, a, s, l, c, u, d, f, p, g, h, m = Pe.get(e);
            if (m)
                for (n.handler && (n = (r = n).handler, o = r.selector), o && ge.find.matchesSelector(He, o), n.guid || (n.guid = ge.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
                        return void 0 !== ge && ge.event.triggered !== t.type ? ge.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(Se) || [""]).length; c--;) p = h = (s = et.exec(t[c]) || [])[1], g = (s[2] || "").split(".").sort(), p && (d = ge.event.special[p] || {}, p = (o ? d.delegateType : d.bindType) || p, d = ge.event.special[p] || {}, u = ge.extend({
                    type: p,
                    origType: h,
                    data: i,
                    handler: n,
                    ...
                    namespace: g.join(".")
                }, r), (f = l[p]) || ((f = l[p] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, g, a) || e.addEventListener && e.addEventListener(p, a)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? f.splice(f.delegateCount++, 0, u) : f.push(u), ge.event.global[p] = !0)
        },
        remove: function(e, t, n, i, o) {
            var r, a, s, l, c, u, d, f, p, g, h, m = Pe.hasData(e) && Pe.get(e);
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(Se) || [""]).length; c--;)
                    if (p = h = (s = et.exec(t[c]) || [])[1], g = (s[2] || "").split(".").sort(), p) {
                        for (d = ge.event.special[p] || {}, f = l[p = (i ? d.delegateType : d.bindType) || p] || [], s = s[2] && new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = r = f.length; r--;) u = f[r], !o && h !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(r, 1), u.selector && f.delegateCount--, d.remove && d.remove.call(e, u));
                        a && !f.length && (d.teardown && !1 !== d.teardown.call(e, g, m.handle) || ge.removeEvent(e, p, m.handle), delete l[p])
                    } else
                        for (p in l) ge.event.remove(e, p + t[c], n, i, !0);
        ...
        dispatch: function(e) {
            var t, n, i, o, r, a, s = ge.event.fix(e),
                ...
                u = ge.event.special[s.type] || {};
            for (l[0] = s, t = 1; t < arguments.length; t++) l[t] = arguments[t];
            if (s.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, s)) {
                for (a = ge.event.handlers.call(this, s, c), t = 0;
                    (o = a[t++]) && !s.isPropagationStopped();)
                    for (s.currentTarget = o.elem, n = 0;
                        (r = o.handlers[n++]) && !s.isImmediatePropagationStopped();) s.rnamespace && !1 !== r.namespace && !s.rnamespace.test(r.namespace) || (s.handleObj = r, s.data = r.data, void 0 !== (i = ((ge.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (s.result = i) && (s.preventDefault(), s.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && 1 <= e.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (r = [], a = {}, n = 0; n < l; n++) void 0 === a[o = (i = t[n]).selector + " "] && (a[o] = i.needsContext ? -1 < ge(o, this).index(c) : ge.find(o, this, null, [c]).length), a[o] && r.push(i);
                        r.length && s.push({
                            elem: c,
                            handlers: r
                        })
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return _e.test(t.type) && t.click && r(t, "input") && S(t, "click", w), !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return _e.test(t.type) && t.click && r(t, "input") && S(t, "click"), !0
                },
                _default: function(e) {
                    var t = e.target;
                    return _e.test(t.type) && t.click && r(t, "input") && Pe.get(t, "click") || r(t, "a")
                }
            },
            beforeunload: {
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? w : C, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && ge.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[ge.expando] = !0
    }, ge.Event.prototype = {
        ...
        ge.event.special[e] = {
            ...
            handle: function(e) {
                var n, i = e.relatedTarget,
                    o = e.handleObj;
                return i && (i === this || ge.contains(this, i)) || (e.type = o.origType, n = o.handler.apply(this, arguments), e.type = t), n
            }
        }
    }), ge.fn.extend({
        on: function(e, t, n, i) {
    ...
    ge.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(ce.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ge.isXMLDoc(e)))
                for (a = b(u), i = 0, o = (r = b(e)).length; i < o; i++) s = r[i], l = a[i], "input" === (c = l.nodeName.toLowerCase()) && _e.test(s.type) ? l.checked = s.checked : "input" !== c && "textarea" !== c || (l.defaultValue = s.defaultValue);
            if (t)
                if (n)
                    for (r = r || b(e), a = a || b(u), i = 0, o = r.length; i < o; i++) D(r[i], a[i]);
                else D(e, u);
            return 0 < (a = b(u, "script")).length && y(a, !d && b(e, "script")), u
        },
        ...
        html: function(e) {
            return je(this, function(e) {
                ...
                if ("string" == typeof e && !nt.test(e) && !Ke[(Be.exec(e) || ["", ""])[1].toLowerCase()]) {
        ...
        ge.fn[e] = function(e) {
            for (var n, i = [], o = ge(e), r = o.length - 1, a = 0; a <= r; a++) n = a === r ? this : this.clone(!0), ge(o[a])[t](n), ne.apply(i, n.get());
            return this.pushStack(i)
        }
    });
    var rt = new RegExp("^(" + Fe + ")(?!px)[a-z%]+$", "i"),
        at = function(t) {
    ...
    ! function() {
        function t() {
            if (c) {
                ...
                i = "1%" !== t.top, s = 12 === n(t.marginLeft), c.style.right = "60%", a = 36 === n(t.right), o = 36 === n(t.width), c.style.position = "absolute", r = 12 === n(c.offsetWidth / 3), He.removeChild(l), c = null
            }
        }
        ...
        var i, o, r, a, s, l = Y.createElement("div"),
    ...
    ge.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, a, s = p(t),
                    l = ft.test(t),
                    c = e.style;
                if (l || (t = q(s)), a = ge.cssHooks[t] || ge.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (o = a.get(e, !1, i)) ? o : c[t];
                "string" == (r = typeof n) && (o = Me.exec(n)) && o[1] && (n = m(e, t, o), r = "number"), null != n && n == n && ("number" !== r || l || (n += o && o[3] || (ge.cssNumber[s] ? "" : "px")), ce.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function(e, t, n, i) {
            var o, r, a, s = p(t);
            return ft.test(t) || (t = q(s)), (a = ge.cssHooks[t] || ge.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = P(e, t, i)), "normal" === o && t in gt && (o = gt[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), ge.each(["height", "width"], function(e, t) {
        ge.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !dt.test(ge.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? M(e, t, i) : Ve(e, pt, function() {
                    return M(e, t, i)
                })
            },
            set: function(e, n, i) {
                var o, r = at(e),
                    ...
                    l = i ? F(e, t, i, s, r) : 0;
                return s && a && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - F(e, t, "border", !1, r) - .5)), l && (o = Me.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = ge.css(e, t)), N(0, n, l)
            }
        }
    }), ge.cssHooks.marginLeft = L(ce.reliableMarginLeft, function(e, t) {
        ...
        }, "margin" !== e && (ge.cssHooks[e + t].set = N)
    }), ge.fn.extend({
        css: function(e, t) {
            return je(this, function(e, t, n) {
                var i, o, r = {},
                    a = 0;
                if (Array.isArray(t)) {
                    for (i = at(e), o = t.length; a < o; a++) r[t[a]] = ge.css(e, t[a], !1, i);
                    return r
                }
        ...
        _default: {
            ...
            set: function(e) {
                ge.fx.step[e.prop] ? ge.fx.step[e.prop](e) : 1 !== e.elem.nodeType || !ge.cssHooks[e.prop] && null == e.elem.style[q(e.prop)] ? e.elem[e.prop] = e.now : ge.style(e.elem, e.prop, e.now + e.unit)
            }
        }
    ...
    var ht, mt, vt, bt, yt = /^(?:toggle|show|hide)$/,
        xt = /queueHooks$/;
    ge.Animation = ge.extend(V, {
        ...
        prefilters: [function(e, t, n) {
            ...
            for (i in n.queue || (null == (a = ge._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function() {
                ...
                for (i in d && 1 === e.nodeType && (n.overflow = [g.overflow, g.overflowX, g.overflowY], null == (c = m && m.display) && (c = Pe.get(e, "display")), "none" === (u = ge.css(e, "display")) && (c ? u = c : (v([e], !0), c = e.style.display || c, u = ge.css(e, "display"), v([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === ge.css(e, "float") && (l || (f.done(function() {
                        g.display = c
                    }), null == c && (u = g.display, c = "none" === u ? "" : u)), g.display = "inline-block")), n.overflow && (g.overflow = "hidden", f.always(function() {
                        g.overflow = n.overflow[0], g.overflowX = n.overflow[1], g.overflowY = n.overflow[2]
                    })), l = !1, p) l || (m ? "hidden" in m && (h = m.hidden) : m = Pe.access(e, "fxshow", {
                    display: c
                }), r && (m.hidden = !h), h && v([e], !0), f.done(function() {
                    for (i in h || v([e]), Pe.remove(e, "fxshow"), p) ge.style(e, i, p[i])
                })), l = U(h ? m[i] : 0, i, f), i in m || (m[i] = l.start, h && (l.end = l.start, l.start = 0))
        }],
        ...
        stop: function(e, t, n) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function() {
                ...
                if (o) a[o] && a[o].stop && i(a[o]);
                    ...
                    for (o in a) a[o] && a[o].stop && xt.test(o) && i(a[o]);
    ...
    }, vt = Y.createElement("input"), bt = Y.createElement("select").appendChild(Y.createElement("option")), vt.type = "checkbox", ce.checkOn = "" !== vt.value, ce.optSelected = bt.selected, (vt = Y.createElement("input")).value = "t", vt.type = "radio", ce.radioValue = "t" === vt.value;
    ...
    ge.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? ge.prop(e, t, n) : (1 === r && ge.isXMLDoc(e) || (o = ge.attrHooks[t.toLowerCase()] || (ge.expr.match.bool.test(t) ? wt : void 0)), void 0 !== n ? null === n ? void ge.removeAttr(e, t) : o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (i = o.get(e, t)) ? i : null == (i = ge.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        Ct[t] = function(e, t, i) {
            ...
            return i || (r = Ct[a], Ct[a] = o, o = null != n(e, t, i) ? a : null, Ct[a] = r), o
        }
    });
    ...
    ge.fn.extend({
        ...
        addClass: function(e) {
            ...
            if (ue(e)) return this.each(function(t) {
                ge(this).addClass(e.call(this, t, _(this)))
            });
            if ((t = B(e)).length)
                for (; n = this[l++];)
                    if (o = _(n), i = 1 === n.nodeType && " " + W(o) + " ") {
                        for (a = 0; r = t[a++];) i.indexOf(" " + r + " ") < 0 && (i += r + " ");
                        o !== (s = W(i)) && n.setAttribute("class", s)
                    } return this
        },
        removeClass: function(e) {
            var t, n, i, o, r, a, s, l = 0;
            if (ue(e)) return this.each(function(t) {
                ge(this).removeClass(e.call(this, t, _(this)))
            });
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : ue(e) ? this.each(function(n) {
                ge(this).toggleClass(e.call(this, n, _(this), t), t)
            }) : this.each(function() {
                var t, o, r, a;
                if (i)
                    for (o = 0, r = ge(this), a = B(e); t = a[o++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                else void 0 !== e && "boolean" !== n || ((t = _(this)) && Pe.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Pe.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)
                if (1 === n.nodeType && -1 < (" " + W(_(n)) + " ").indexOf(t)) return !0;
            return !1
        }
    });
    var St = /\r/g;
    ge.fn.extend({
        val: function(e) {
            ...
            return arguments.length ? (i = ue(e), this.each(function(n) {
                var o;
                1 === this.nodeType && (null == (o = i ? e.call(this, n, ge(this).val()) : e) ? o = "" : "number" == typeof o ? o += "" : Array.isArray(o) && (o = ge.map(o, function(e) {
                    return null == e ? "" : e + ""
                })), (t = ge.valHooks[this.type] || ge.valHooks[this.nodeName.toLowerCase()]) && "set" in t && void 0 !== t.set(this, o, "value") || (this.value = o))
            })) : o ? (t = ge.valHooks[o.type] || ge.valHooks[o.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(o, "value")) ? n : "string" == typeof(n = o.value) ? n.replace(St, "") : null == n ? "" : n : void 0
        }
    }), ge.extend({
        valHooks: {
            option: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, i, o = e.options, r = ge.makeArray(t), a = o.length; a--;)((i = o[a]).selected = -1 < ge.inArray(ge.valHooks.option.get(i), r)) && (n = !0);
    ...
    ge.extend(ge.event, {
        trigger: function(t, n, i, o) {
            var r, a, s, l, c, u, d, f, p = [i || Y],
                g = ae.call(t, "type") ? t.type : t,
                h = ae.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = f = s = i = i || Y, 3 !== i.nodeType && 8 !== i.nodeType && !At.test(g + ge.event.triggered) && (-1 < g.indexOf(".") && (g = (h = g.split(".")).shift(), h.sort()), c = g.indexOf(":") < 0 && "on" + g, (t = t[ge.expando] ? t : new ge.Event(g, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : ge.makeArray(n, [t]), d = ge.event.special[g] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!o && !d.noBubble && !de(i)) {
                    for (l = d.delegateType || g, At.test(l + g) || (a = a.parentNode); a; a = a.parentNode) p.push(a), s = a;
                    s === (i.ownerDocument || Y) && p.push(s.defaultView || s.parentWindow || e)
                }
                for (r = 0;
                    (a = p[r++]) && !t.isPropagationStopped();) f = a, t.type = 1 < r ? l : d.bindType || g, (u = (Pe.get(a, "events") || {})[t.type] && Pe.get(a, "handle")) && u.apply(a, n), (u = c && a[c]) && u.apply && Oe(a) && (t.result = u.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = g, o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(p.pop(), n) || !Oe(i) || c && ue(i[g]) && !de(i) && ((s = i[c]) && (i[c] = null), ge.event.triggered = g, t.isPropagationStopped() && f.addEventListener(g, Et), i[g](), t.isPropagationStopped() && f.removeEventListener(g, Et), ge.event.triggered = void 0, s && (i[c] = s)), t.result
            }
        },
    ...
    ge.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !ge(this).is(":disabled") && qt.test(this.nodeName) && !Lt.test(e) && (this.checked || !_e.test(e))
            }).map(function(e, t) {
                var n = ge(this).val();
    ...
    Wt.href = jt.href, ge.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, s) {
                var c, f, p, x, w, C = n;
                u || (u = !0, l && e.clearTimeout(l), o = void 0, a = s || "", k.readyState = 0 < t ? 4 : 0, c = 200 <= t && t < 300 || 304 === t, i && (x = function(e, t, n) {
                ...
                }(g, x, k, c), c ? (g.ifModified && ((w = k.getResponseHeader("Last-Modified")) && (ge.lastModified[r] = w), (w = k.getResponseHeader("etag")) && (ge.etag[r] = w)), 204 === t || "HEAD" === g.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = x.state, f = x.data, c = !(p = x.error))) : (p = C, !t && C || (C = "error", t < 0 && (t = 0))), k.status = t, k.statusText = (n || C) + "", c ? v.resolveWith(h, [f, C, k]) : v.rejectWith(h, [k, C, p]), k.statusCode(y), y = void 0, d && m.trigger(c ? "ajaxSuccess" : "ajaxError", [k, g, c ? f : p]), b.fireWith(h, [k, C]), d && (m.trigger("ajaxComplete", [k, g]), --ge.active || ge.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var o, r, a, s, l, c, u, d, f, p, g = ge.ajaxSetup({}, n),
                h = g.context || g,
                m = g.context && (h.nodeType || h.jquery) ? ge(h) : ge.event,
                v = ge.Deferred(),
            ...
            if (v.promise(k), g.url = ((t || g.url || jt.href) + "").replace($t, jt.protocol + "//"), g.type = n.method || n.type || g.method || g.type, g.dataTypes = (g.dataType || "*").toLowerCase().match(Se) || [""], null == g.crossDomain) {
                c = Y.createElement("a");
                try {
            ...
            if (g.data && g.processData && "string" != typeof g.data && (g.data = ge.param(g.data, g.traditional)), Q(zt, g, n, k), u) return k;
            for (f in (d = ge.event && g.global) && 0 == ge.active++ && ge.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !Ht.test(g.type), r = g.url.replace(Ft, ""), g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Nt, "+")) : (p = g.url.slice(r.length), g.data && (g.processData || "string" == typeof g.data) && (r += (Rt.test(r) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (r = r.replace(Mt, "$1"), p = (Rt.test(r) ? "&" : "?") + "_=" + Dt++ + p), g.url = r + p), g.ifModified && (ge.lastModified[r] && k.setRequestHeader("If-Modified-Since", ge.lastModified[r]), ge.etag[r] && k.setRequestHeader("If-None-Match", ge.etag[r])), (g.data && g.hasContent && !1 !== g.contentType || n.contentType) && k.setRequestHeader("Content-Type", g.contentType), k.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Vt + "; q=0.01" : "") : g.accepts["*"]), g.headers) k.setRequestHeader(f, g.headers[f]);
            if (g.beforeSend && (!1 === g.beforeSend.call(h, k, g) || u)) return k.abort();
            if (C = "abort", b.add(g.complete), k.done(g.success), k.fail(g.error), o = Q(Ut, g, n, k)) {
                if (k.readyState = 1, d && m.trigger("ajaxSend", [k, g]), u) return k;
                g.async && 0 < g.timeout && (l = e.setTimeout(function() {
                    k.abort("timeout")
                }, g.timeout));
                try {
                    u = !1, o.send(x, i)
        ...
        ge[t] = function(e, n, i, o) {
            return ue(n) && (o = o || i, i = n, n = void 0), ge.ajax(ge.extend({
                url: e,
                type: t,
                dataType: o,
                data: n,
    ...
    ce.cors = !!Bt && "withCredentials" in Bt, ce.ajax = Bt = !!Bt, ge.ajaxTransport(function(t) {
        var n, i;
        if (ce.cors || Bt && !t.crossDomain) return {
            send: function(o, r) {
                ...
                n = function(e) {
                    return function() {
                        n && (n = i = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? r(0, "error") : r(s.status, s.statusText) : r(_t[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                            binary: s.response
                        } : {
                            text: s.responseText
    ...
    ge.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = ue(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Qt, "$1" + o) : !1 !== t.jsonp && (t.url += (Rt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function() {
            return a || ge.error(o + " was not called"), a[0]
        }, t.dataTypes[0] = "json", r = e[o], e[o] = function() {
            a = arguments
        }, i.always(function() {
            void 0 === r ? ge(e).removeProp(o) : e[o] = r, t[o] && (t.jsonpCallback = n.jsonpCallback, Kt.push(o)), a && ue(r) && r(a[0]), a = r = void 0
        }), "script"
    }), ce.createHTMLDocument = ((Xt = Y.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Xt.childNodes.length), ge.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (ce.createHTMLDocument ? ((i = (t = Y.implementation.createHTMLDocument("")).createElement("base")).href = Y.location.href, t.head.appendChild(i)) : t = Y), r = !n && [], (o = xe.exec(e)) ? [t.createElement(o[1])] : (o = x([e], t, r), r && r.length && ge(r).remove(), ge.merge([], o.childNodes)));
        var i, o, r
    }, ge.fn.load = function(e, t, n) {
        var i, o, r, a = this,
            s = e.indexOf(" ");
        return -1 < s && (i = W(e.slice(s)), e = e.slice(0, s)), ue(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < a.length && ge.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        ge.cssHooks[t] = L(ce.pixelPosition, function(e, n) {
            if (n) return n = P(e, t), rt.test(n) ? ge(e).position()[t] + "px" : n
        })
    }), ge.each({
        Height: "height",
        Width: "width"
        ...
        var n, i, o;
        if ("string" == typeof t && (n = e[t], t = e, e = n), ue(e)) return i = ee.call(arguments, 2), (o = function() {
            return e.apply(t || this, i.concat(ee.call(arguments)))
        }).guid = e.guid = e.guid || ge.guid++, o
    }, ge.holdReady = function(e) {
        e ? ge.readyWait++ : ge.ready(!0)
    }, ge.isArray = Array.isArray, ge.parseJSON = JSON.parse, ge.nodeName = r, ge.isFunction = ue, ge.isWindow = de, ge.camelCase = p, ge.type = i, ge.now = Date.now, ge.isNumeric = function(e) {
        var t = ge.type(e);
    ...
    return ge.noConflict = function(t) {
        return e.$ === ge && (e.$ = Gt), t && e.jQuery === ge && (e.jQuery = Jt), ge
    }, t || (e.jQuery = e.$ = ge), ge
}),
/**
...
function(e) {
    ...
    function t() {
        ...
        var a = n(this);
        return isNaN(a.datetime) || (0 === t.cutoff || Math.abs(o(a.datetime)) < t.cutoff ? e(this).text(i(a.datetime)) : e(this).attr("title").length > 0 && e(this).text(e(this).attr("title"))), this
    }
    ...
    e.extend(e.timeago, {
        ...
        inWords: function(t) {
            ...
            var i = this.settings.strings,
                o = i.prefixAgo,
                r = i.suffixAgo;
            if (this.settings.allowFuture && t < 0 && (o = i.prefixFromNow, r = i.suffixFromNow), !this.settings.allowPast && t >= 0) return this.settings.strings.inPast;
            var a = Math.abs(t) / 1e3,
                s = a / 60,
                l = s / 60,
                c = l / 24,
                u = c / 365,
                d = a < 45 && n(i.seconds, Math.round(a)) || a < 90 && n(i.minute, 1) || s < 45 && n(i.minutes, Math.round(s)) || s < 90 && n(i.hour, 1) || l < 24 && n(i.hours, Math.round(l)) || l < 42 && n(i.day, 1) || c < 30 && n(i.days, Math.round(c)) || c < 45 && n(i.month, 1) || c < 365 && n(i.months, Math.round(c / 30)) || u < 1.5 && n(i.year, 1) || n(i.years, Math.round(u)),
                f = i.wordSeparator || "";
            return void 0 === i.wordSeparator && (f = " "), e.trim([o, d, r].join(f))
        },
        parse: function(t) {
            var n = e.trim(t);
    ...
    var a = {
        ...
        update: function(n) {
            var i = n instanceof Date ? n : r.parse(n);
            e(this).data("timeago", {
                datetime: i
    ...
    e.site = e.fn.site = function(o) {
        ...
        return r = {
            ...
            instantiate: function() {
                r.verbose("Storing instance of site", r), y = r, v.data(h, r)
            },
            normalize: function() {
            ...
            fix: {
                ...
                requestAnimationFrame: function() {
                    r.debug("Normalizing requestAnimationFrame"), t.requestAnimationFrame === i && (r.debug("RequestAnimationFrame not available, normalizing event"), t.requestAnimationFrame = t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame || function(e) {
                        setTimeout(e, 0)
                    })
                }
            },
            ...
            change: {
                setting: function(t, n, o, a) {
                    o = "string" == typeof o ? "all" === o ? f.modules : [o] : o || f.modules, a = a === i || a, e.each(o, function(i, o) {
                        var s, l = !r.moduleExists(o) || e.fn[o].settings.namespace || !1;
            ...
            console: function(e) {
                if (e) {
                    if (y.cache.console === i) return void r.error(g.console);
            ...
            destroy: function() {
                r.verbose("Destroying previous site for", v), v.removeData(h)
            },
            cache: {},
            ...
            invoke: function(t, n, o) {
                ...
                return n = n || d, o = b || o, "string" == typeof t && u !== i && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function(n, o) {
                    ...
                    if (e.isPlainObject(u[a]) && n != s) u = u[a];
                        ...
                        if (!e.isPlainObject(u[o]) || n == s) return u[o] !== i ? (l = u[o], !1) : (r.error(g.method, t), !1);
                        u = u[o]
                    }
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.form = function(t) {
        ...
        return r.each(function() {
            var p, g, h, m, v, b, y, x, w, C, k, T, S, A, E, j, D, R, O = e(this),
                P = this,
                L = [],
                q = !1;
            R = {
                initialize: function() {
                    R.get.settings(), d ? (D === i && R.instantiate(), R.invoke(c)) : (D !== i && D.invoke("destroy"), R.verbose("Initializing form validation", O, x), R.bindEvents(), R.set.defaults(), R.instantiate())
                },
                instantiate: function() {
                    R.verbose("Storing instance of module", R), D = R, O.data(E, R)
                },
                destroy: function() {
                    R.verbose("Destroying previous module", D), R.removeEvents(), O.removeData(E)
                },
                refresh: function() {
                    R.verbose("Refreshing selector cache"), p = O.find(k.field), g = O.find(k.group), h = O.find(k.message), m = O.find(k.prompt), v = O.find(k.submit), b = O.find(k.clear), y = O.find(k.reset)
                },
                submit: function() {
                    R.verbose("Submitting form", O), O.submit()
                },
                attachEvents: function(t, n) {
                    n = n || "submit", e(t).on("click" + j, function(e) {
                        R[n](), e.preventDefault()
                    })
                },
                bindEvents: function() {
                    R.verbose("Attaching form events"), O.on("submit" + j, R.validate.form).on("blur" + j, k.field, R.event.field.blur).on("click" + j, k.submit, R.submit).on("click" + j, k.reset, R.reset).on("click" + j, k.clear, R.clear), x.keyboardShortcuts && O.on("keydown" + j, k.field, R.event.field.keydown), p.each(function() {
                        var t = e(this),
                            n = t.prop("type"),
                            i = R.get.changeEvent(n, t);
                        e(this).on(i + j, R.event.field.change)
                    })
                },
                clear: function() {
                    p.each(function() {
                        var t = e(this),
                            ...
                            a = n.is(k.uiCheckbox),
                            s = n.is(k.uiDropdown);
                        i.hasClass(T.error) && (R.verbose("Resetting error on field", i), i.removeClass(T.error), o.remove()), s ? (R.verbose("Resetting dropdown value", n, r), n.dropdown("clear")) : a ? t.prop("checked", !1) : (R.verbose("Resetting field value", t, r), t.val(""))
                    })
                },
                reset: function() {
                    p.each(function() {
                ...
                is: {
                    ...
                    empty: function(e) {
                        return !e || 0 === e.length || (e.is('input[type="checkbox"]') ? !e.is(":checked") : R.is.blank(e))
                    },
                    blank: function(t) {
                        return "" === e.trim(t.val())
                    },
                    valid: function() {
                        ...
                        return R.verbose("Checking if form is valid"), e.each(w, function(e, n) {
                            R.validate.field(n, e) || (t = !1)
                        }), t
                    }
                },
                removeEvents: function() {
                    O.off(j), p.off(j), v.off(j), p.off(j)
                },
                event: {
                    field: {
                        keydown: function(t) {
                            ...
                            i == s.escape && (R.verbose("Escape key pressed blurring field"), n.blur()), t.ctrlKey || i != s.enter || !o || a || r || (q || (n.one("keyup" + j, R.event.field.keyup), R.submit(), R.debug("Enter pressed on input submitting form")), q = !0)
                        },
                        keyup: function() {
                            q = !1
                        },
                        blur: function(t) {
                            ...
                            i.hasClass(T.error) ? (R.debug("Revalidating field", n, o), o && R.validate.field(o)) : "blur" != x.on && "change" != x.on || o && R.validate.field(o)
                        },
                        change: function(t) {
                            var n = e(this),
                                i = n.closest(g),
                                o = R.get.validation(n);
                            ("change" == x.on || i.hasClass(T.error) && x.revalidate) && (clearTimeout(R.timer), R.timer = setTimeout(function() {
                                R.debug("Revalidating field", n, R.get.validation(n)), R.validate.field(o)
                            }, x.delay))
                        }
                    }
                },
                get: {
                    ancillaryValue: function(e) {
                        return !(!e.type || !e.value && !R.is.bracketedRule(e)) && (e.value !== i ? e.value : e.type.match(x.regExp.bracket)[1] + "")
                    },
                    ruleName: function(e) {
                        return R.is.bracketedRule(e) ? e.type.replace(e.type.match(x.regExp.bracket)[0], "") : e.type
                    },
                    ...
                    prompt: function(e, t) {
                        var n, i, o, r = R.get.ruleName(e),
                            a = R.get.ancillaryValue(e),
                            s = e.prompt || x.prompt[r] || x.text.unspecifiedRule,
                            l = -1 !== s.search("{value}"),
                            c = -1 !== s.search("{name}");
                        return (c || l) && (i = R.get.field(t.identifier)), l && (s = s.replace("{value}", i.val())), c && (n = i.closest(k.group).find("label").eq(0), o = 1 == n.length ? n.text() : i.prop("placeholder") || x.text.unspecifiedField, s = s.replace("{name}", o)), s = s.replace("{identifier}", t.identifier), s = s.replace("{ruleValue}", a), e.prompt || R.verbose("Using default validation prompt for type", s, r), s
                    },
                    settings: function() {
                        if (e.isPlainObject(t)) {
                            var n, o = Object.keys(t);
                            o.length > 0 && t[o[0]].identifier !== i && t[o[0]].rules !== i ? (x = e.extend(!0, {}, e.fn.form.settings, u), w = e.extend({}, e.fn.form.settings.defaults, t), R.error(x.error.oldSyntax, P), R.verbose("Extending settings from legacy parameters", w, x)) : (t.fields && (n = Object.keys(t.fields), ("string" == typeof t.fields[n[0]] || e.isArray(t.fields[n[0]])) && e.each(t.fields, function(n, i) {
                            ...
                            })), x = e.extend(!0, {}, e.fn.form.settings, t), w = e.extend({}, e.fn.form.settings.defaults, x.fields), R.verbose("Extending settings", w, x))
                        } else x = e.fn.form.settings, w = e.fn.form.settings.defaults, R.verbose("Using default form validation", w, x);
                        A = x.namespace, C = x.metadata, k = x.selector, T = x.className, S = x.error, E = "module-" + A, j = "." + A, D = O.data(E), R.refresh()
                    },
                    field: function(t) {
                    ...
                    validation: function(t) {
                        ...
                        return !!w && (e.each(w, function(e, o) {
                            i = o.identifier || e, R.get.field(i)[0] == t[0] && (o.identifier = i, n = o)
                        }), n || !1)
                    },
                    value: function(e) {
                        var t, n = [];
                ...
                has: {
                    field: function(e) {
                        return R.verbose("Checking for existence of a field with identifier", e), "string" != typeof e && R.error(S.identifier, e), p.filter("#" + e).length > 0 || p.filter('[name="' + e + '"]').length > 0 || p.filter("[data-" + C.validate + '="' + e + '"]').length > 0
                    }
                },
                add: {
                    prompt: function(t, n) {
                    ...
                    errors: function(e) {
                        R.debug("Adding form error messages", e), R.set.error(), h.html(x.templates.error(e))
                    }
                },
                remove: {
                    prompt: function(t) {
                        ...
                        o.removeClass(T.error), x.inline && r.is(":visible") && (R.verbose("Removing prompt for field", t), x.transition && e.fn.transition !== i && O.transition("is supported") ? r.transition(x.transition + " out", x.duration, function() {
                            r.remove()
                    ...
                    values: function(t) {
                        e.isEmptyObject(t) || e.each(t, function(t, n) {
                            var i, o = R.get.field(t),
                                ...
                                l = r.is(k.uiDropdown),
                                c = o.is(k.radio) && s;
                            o.length > 0 && (a && s ? (R.verbose("Selecting multiple", n, o), r.checkbox("uncheck"), e.each(n, function(e, t) {
                                i = o.filter('[value="' + t + '"]'), r = i.parent(), i.length > 0 && r.checkbox("check")
                            })) : c ? (R.verbose("Selecting radio value", n, o), o.filter('[value="' + n + '"]').parent(k.uiCheckbox).checkbox("check")) : s ? (R.verbose("Setting checkbox value", n, r), !0 === n ? r.checkbox("check") : r.checkbox("uncheck")) : l ? (R.verbose("Setting dropdown value", n, r), r.dropdown("set selected", n)) : (R.verbose("Setting field value", n, o), o.val(n)))
                        })
                    }
                },
                validate: {
                    form: function(e, t) {
                        ...
                        if (q) return !1;
                        if (L = [], R.is.valid()) {
                            if (R.debug("Form has no validation errors, submitting"), R.set.success(), !0 !== t) return x.onSuccess.call(P, e, n)
                        } else if (R.debug("Form has errors"), R.set.error(), x.inline || R.add.errors(L), O.data("moduleApi") !== i && e.stopImmediatePropagation(), !0 !== t) return x.onFailure.call(P, L, n)
                    },
                    field: function(t, n) {
                        var o = t.identifier || n,
                            ...
                            s = !0,
                            l = [];
                        return t.identifier || (R.debug("Using field name as identifier", o), t.identifier = o), r.prop("disabled") ? (R.debug("Field is disabled. Skipping", o), s = !0) : t.optional && R.is.blank(r) ? (R.debug("Field is optional and blank. Skipping", o), s = !0) : t.depends && R.is.empty(a) ? (R.debug("Field depends on another value that is not present or empty. Skipping", a), s = !0) : t.rules !== i && e.each(t.rules, function(e, n) {
                            R.has.field(o) && !R.validate.rule(t, n) && (R.debug("Field is invalid", o, n.type), l.push(R.get.prompt(n, t)), s = !1)
                        }), s ? (R.remove.prompt(o, l), x.onValid.call(r), !0) : (L = L.concat(l), R.add.prompt(o, l), x.onInvalid.call(r, l), !1)
                    },
                    rule: function(t, n) {
                        var o = R.get.field(t.identifier),
                            r = (n.type, o.val()),
                            a = R.get.ancillaryValue(n),
                            s = R.get.ruleName(n),
                            l = x.rules[s];
                        return e.isFunction(l) ? (r = r === i || "" === r || null === r ? "" : e.trim(r + ""), l.call(o, r, a)) : void R.error(S.noRule, s)
                    }
                },
                setting: function(t, n) {
                ...
                debug: function() {
                    !x.silent && x.debug && (x.performance ? R.performance.log(arguments) : (R.debug = Function.prototype.bind.call(console.info, console, x.name + ":"), R.debug.apply(console, arguments)))
                },
                verbose: function() {
                    !x.silent && x.verbose && x.debug && (x.performance ? R.performance.log(arguments) : (R.verbose = Function.prototype.bind.call(console.info, console, x.name + ":"), R.verbose.apply(console, arguments)))
                },
                error: function() {
                    x.silent || (R.error = Function.prototype.bind.call(console.error, console, x.name + ":"), R.error.apply(console, arguments))
                },
                performance: {
                    log: function(e) {
                        var t, n, i;
                ...
                invoke: function(t, n, r) {
                    ...
                    return n = n || f, r = P || r, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function(n, o) {
                        ...
                        if (e.isPlainObject(c[r]) && n != a) c = c[r];
                            ...
                            if (!e.isPlainObject(c[o]) || n == a) return c[o] !== i && (s = c[o], !1);
                            c = c[o]
                        }
        ...
        rules: {
            ...
            integer: function(t, n) {
                ...
                return n && -1 === ["", ".."].indexOf(n) && (-1 == n.indexOf("..") ? s.test(n) && (o = r = n - 0) : (a = n.split("..", 2), s.test(a[0]) && (o = a[0] - 0), s.test(a[1]) && (r = a[1] - 0))), s.test(t) && (o === i || t >= o) && (r === i || t <= r)
            },
            decimal: function(t) {
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.accordion = function(n) {
        ...
        return t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame, r.each(function() {
            ...
            f = {
                initialize: function() {
                    f.debug("Initializing", w), f.bind.events(), p.observeChanges && f.observeChanges(), f.instantiate()
                },
                instantiate: function() {
                    S = f, w.data(y, f)
                },
                ...
                refresh: function() {
                    C = w.find(m.title), k = w.find(m.content)
                },
                ...
                bind: {
                    events: function() {
                        f.debug("Binding delegated events"), w.on(p.on + b, m.trigger, f.event.click)
                    }
                },
                event: {
                    click: function() {
                ...
                toggle: function(t) {
                    var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t).closest(m.title) : e(this).closest(m.title),
                        o = n.next(k),
                        r = o.hasClass(g.animating),
                ...
                open: function(t) {
                    var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t).closest(m.title) : e(this).closest(m.title),
                        o = n.next(k),
                        r = o.hasClass(g.animating);
                    return o.hasClass(g.active) || r ? void f.debug("Accordion already open, skipping", o) : (f.debug("Opening accordion content", n), p.onOpening.call(o), p.exclusive && f.closeOthers.call(n), n.addClass(g.active), o.stop(!0, !0).addClass(g.animating), p.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
                        animation: "fade in",
                        queue: !1,
                        useFailSafe: !0,
                        debug: p.debug,
                        ...
                        o.removeClass(g.animating).addClass(g.active), f.reset.display.call(this), p.onOpen.call(this), p.onChange.call(this)
                    }))
                },
                close: function(t) {
                    var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t).closest(m.title) : e(this).closest(m.title),
                        ...
                        s = !a && r,
                        l = a && r;
                    !a && !s || l || (f.debug("Closing accordion content", o), p.onClosing.call(o), n.removeClass(g.active), o.stop(!0, !0).addClass(g.animating), p.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
                        animation: "fade out",
                        queue: !1,
                        useFailSafe: !0,
                        debug: p.debug,
                        ...
                        o.removeClass(g.animating).removeClass(g.active), f.reset.display.call(this), p.onClose.call(this), p.onChange.call(this)
                    }))
                },
                closeOthers: function(t) {
                    var n, o, r, a = t !== i ? C.eq(t) : e(this).closest(m.title),
                        s = a.parents(m.content).prev(m.title),
                        l = a.closest(m.accordion),
                        c = m.title + "." + g.active + ":visible",
                        u = m.content + "." + g.active + ":visible";
                    p.closeNested ? (n = l.find(c).not(s), r = n.next(k)) : (n = l.find(c).not(s), o = l.find(u).find(c).not(s), n = n.not(o), r = n.next(k)), n.length > 0 && (f.debug("Exclusive enabled, closing other content", n), n.removeClass(g.active), r.removeClass(g.animating).stop(!0, !0), p.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? r.children().transition({
                        animation: "fade out",
                        useFailSafe: !0,
                        debug: p.debug,
                        verbose: p.verbose,
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.checkbox = function(o) {
        ...
        return a.each(function() {
            var a, p, g = e.extend(!0, {}, e.fn.checkbox.settings, o),
                h = g.className,
                m = g.namespace,
                v = g.selector,
                b = g.error,
            ...
            p = {
                initialize: function() {
                    p.verbose("Initializing checkbox", g), p.create.label(), p.bind.events(), p.set.tabbable(), p.hide.input(), p.observeChanges(), p.instantiate(), p.setup()
                },
                instantiate: function() {
                    p.verbose("Storing instance of module", p), E = p, w.data(x, p)
                },
                destroy: function() {
                    p.verbose("Destroying module"), p.unbind.events(), p.show.input(), w.removeData(x)
                },
                fix: {
                    reference: function() {
                ...
                refresh: function() {
                    C = w.children(v.label), k = w.children(v.input), T = k[0]
                },
                hide: {
                    input: function() {
                        p.verbose("Modifying <input> z-index to be unselectable"), k.addClass(h.hidden)
                    }
                },
                show: {
                    input: function() {
                        p.verbose("Modifying <input> z-index to be selectable"), k.removeClass(h.hidden)
                    }
                },
                observeChanges: function() {
                ...
                attachEvents: function(t, n) {
                    var i = e(t);
                    n = e.isFunction(p[n]) ? p[n] : p.toggle, i.length > 0 ? (p.debug("Attaching checkbox events to element", t, n), i.on("click" + y, n)) : p.error(b.notFound)
                },
                event: {
                    click: function(t) {
                        var n = e(t.target);
                ...
                check: function() {
                    p.should.allowCheck() && (p.debug("Checking checkbox", k), p.set.checked(), p.should.ignoreCallbacks() || (g.onChecked.call(T), g.onChange.call(T)))
                },
                uncheck: function() {
                    p.should.allowUncheck() && (p.debug("Unchecking checkbox"), p.set.unchecked(), p.should.ignoreCallbacks() || (g.onUnchecked.call(T), g.onChange.call(T)))
                },
                indeterminate: function() {
                    return p.should.allowIndeterminate() ? void p.debug("Checkbox is already indeterminate") : (p.debug("Making checkbox indeterminate"), p.set.indeterminate(), void(p.should.ignoreCallbacks() || (g.onIndeterminate.call(T), g.onChange.call(T))))
                },
                determinate: function() {
                    return p.should.allowDeterminate() ? void p.debug("Checkbox is already determinate") : (p.debug("Making checkbox determinate"), p.set.determinate(), void(p.should.ignoreCallbacks() || (g.onDeterminate.call(T), g.onChange.call(T))))
                },
                enable: function() {
                    return p.is.enabled() ? void p.debug("Checkbox is already enabled") : (p.debug("Enabling checkbox"), p.set.enabled(), g.onEnable.call(T), void g.onEnabled.call(T))
                },
                disable: function() {
                    return p.is.disabled() ? void p.debug("Checkbox is already disabled") : (p.debug("Disabling checkbox"), p.set.disabled(), g.onDisable.call(T), void g.onDisabled.call(T))
                },
                get: {
                    radios: function() {
                        var t = p.get.name();
                ...
                should: {
                    allowCheck: function() {
                        return p.is.determinate() && p.is.checked() && !p.should.forceCallbacks() ? (p.debug("Should not allow check, checkbox is already checked"), !1) : !1 !== g.beforeChecked.apply(T) || (p.debug("Should not allow check, beforeChecked cancelled"), !1)
                    },
                    allowUncheck: function() {
                        return p.is.determinate() && p.is.unchecked() && !p.should.forceCallbacks() ? (p.debug("Should not allow uncheck, checkbox is already unchecked"), !1) : !1 !== g.beforeUnchecked.apply(T) || (p.debug("Should not allow uncheck, beforeUnchecked cancelled"), !1)
                    },
                    allowIndeterminate: function() {
                        return p.is.indeterminate() && !p.should.forceCallbacks() ? (p.debug("Should not allow indeterminate, checkbox is already indeterminate"), !1) : !1 !== g.beforeIndeterminate.apply(T) || (p.debug("Should not allow indeterminate, beforeIndeterminate cancelled"), !1)
                    },
                    allowDeterminate: function() {
                        return p.is.determinate() && !p.should.forceCallbacks() ? (p.debug("Should not allow determinate, checkbox is already determinate"), !1) : !1 !== g.beforeDeterminate.apply(T) || (p.debug("Should not allow determinate, beforeDeterminate cancelled"), !1)
                    },
                    forceCallbacks: function() {
                        return p.is.initialLoad() && g.fireOnInit
                    },
                ...
                can: {
                    ...
                    uncheck: function() {
                        return "boolean" == typeof g.uncheckable ? g.uncheckable : !p.is.radio()
                    }
                },
                set: {
                    initialLoad: function() {
                    ...
                    tabbable: function() {
                        p.verbose("Adding tabindex to checkbox"), k.attr("tabindex") === i && k.attr("tabindex", 0)
                    }
                },
                remove: {
                    initialLoad: function() {
                ...
                bind: {
                    events: function() {
                        p.verbose("Attaching checkbox events"), w.on("click" + y, p.event.click).on("keydown" + y, v.input, p.event.keydown).on("keyup" + y, v.input, p.event.keyup)
                    }
                },
                unbind: {
                    events: function() {
                        p.debug("Removing events"), w.off(y)
                    }
                },
                uncheckOthers: function() {
                    var e = p.get.otherRadios();
                    p.debug("Unchecking other radios", e), e.removeClass(h.checked)
                },
                toggle: function() {
                    return p.can.change() ? void(p.is.indeterminate() || p.is.unchecked() ? (p.debug("Currently unchecked"), p.check()) : p.is.checked() && p.can.uncheck() && (p.debug("Currently checked"), p.uncheck())) : void(p.is.radio() || p.debug("Checkbox is read-only or disabled, ignoring toggle"))
                },
                setting: function(t, n) {
                ...
                invoke: function(t, n, o) {
                    var a, s, l, c = E;
                    return n = n || f, o = j || o, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function(n, o) {
                        var r = n != a ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(c[r]) && n != a) c = c[r];
                        else {
                            if (c[r] !== i) return s = c[r], !1;
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.dimmer = function(t) {
        var o, r = e(this),
            ...
            u = [].slice.call(arguments, 1);
        return r.each(function() {
            var d, f, p, g = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.dimmer.settings, t) : e.extend({}, e.fn.dimmer.settings),
                h = g.selector,
                m = g.namespace,
                v = g.className,
                b = g.error,
            ...
            p = {
                preinitialize: function() {
                    p.is.dimmer() ? (f = k.parent(), d = k) : (f = k, d = p.has.dimmer() ? g.dimmerName ? f.find(h.dimmer).filter("." + g.dimmerName) : f.find(h.dimmer) : p.create(), p.set.variation())
                },
                initialize: function() {
                    p.debug("Initializing dimmer", g), p.bind.events(), p.set.dimmable(), p.instantiate()
                },
                instantiate: function() {
                ...
                bind: {
                    events: function() {
                        "hover" == g.on ? f.on("mouseenter" + y, p.show).on("mouseleave" + y, p.hide) : "click" == g.on && f.on(C + y, p.toggle), p.is.page() && (p.debug("Setting as a page dimmer", f), p.set.pageDimmer()), p.is.closable() && (p.verbose("Adding dimmer close event", d), f.on(C + y, h.dimmer, p.event.click))
                    }
                },
                unbind: {
                    events: function() {
                ...
                event: {
                    click: function(t) {
                        p.verbose("Determining if event occured on dimmer", t), (0 === d.find(t.target).length || e(t.target).is(h.content)) && (p.hide(), t.stopImmediatePropagation())
                    }
                },
                ...
                create: function() {
                    ...
                    return g.dimmerName && (p.debug("Creating named dimmer", g.dimmerName), t.addClass(g.dimmerName)), t.appendTo(f), t
                },
                show: function(t) {
                    t = e.isFunction(t) ? t : function() {}, p.debug("Showing dimmer", d, g), p.is.dimmed() && !p.is.animating() || !p.is.enabled() ? p.debug("Dimmer is already shown or disabled") : (p.animate.show(t), g.onShow.call(T), g.onChange.call(T))
                },
                hide: function(t) {
                    t = e.isFunction(t) ? t : function() {}, p.is.dimmed() || p.is.animating() ? (p.debug("Hiding dimmer", d), p.animate.hide(t), g.onHide.call(T), g.onChange.call(T)) : p.debug("Dimmer is not visible")
                },
                toggle: function() {
                ...
                animate: {
                    show: function(t) {
                        t = e.isFunction(t) ? t : function() {}, g.useCSS && e.fn.transition !== i && d.transition("is supported") ? ("auto" !== g.opacity && p.set.opacity(), d.transition({
                        ...
                        })) : (p.verbose("Showing dimmer animation with javascript"), p.set.dimmed(), "auto" == g.opacity && (g.opacity = .8), d.stop().css({
                            opacity: 0,
                            width: "100%",
                            height: "100%"
                        }).fadeTo(p.get.duration(), g.opacity, function() {
                            d.removeAttr("style"), p.set.active(), t()
                        }))
                    },
                    hide: function(t) {
                        t = e.isFunction(t) ? t : function() {}, g.useCSS && e.fn.transition !== i && d.transition("is supported") ? (p.verbose("Hiding dimmer with css"), d.transition({
                ...
                get: {
                    ...
                    duration: function() {
                        return "object" == typeof g.duration ? p.is.active() ? g.duration.hide : g.duration.show : g.duration
                    }
                },
                has: {
                    dimmer: function() {
                        return g.dimmerName ? k.find(h.dimmer).filter("." + g.dimmerName).length > 0 : k.find(h.dimmer).length > 0
                    }
                },
                is: {
                    active: function() {
                ...
                set: {
                    opacity: function(e) {
                        var t = d.css("background-color"),
                            ...
                            i = n && 3 == n.length,
                            o = n && 4 == n.length;
                        e = 0 === g.opacity ? 0 : g.opacity || e, i || o ? (n[3] = e + ")", t = n.join(",")) : t = "rgba(0, 0, 0, " + e + ")", p.debug("Setting opacity to", e), d.css("background-color", t)
                    },
                    active: function() {
                        d.addClass(v.active)
                    },
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.dropdown = function(o) {
        ...
        return a.each(function(h) {
            var m, v, b, y, x, w, C, k, T = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.dropdown.settings, o) : e.extend({}, e.fn.dropdown.settings),
                S = T.className,
                A = T.message,
                E = T.fields,
                j = T.keys,
                ...
                U = M.find(P.input),
                V = M.find(P.icon),
                W = M.prev().find(P.text).length > 0 ? M.prev().find(P.text) : M.prev(),
                _ = M.children(P.menu),
                B = _.find(P.item),
                X = !1,
                K = !1,
            ...
            k = {
                ...
                instantiate: function() {
                    k.verbose("Storing instance of dropdown", k), G = k, M.data(F, k)
                },
                destroy: function() {
                    k.verbose("Destroying previous dropdown", M), k.remove.tabbable(), M.off(N).removeData(F), _.off(N), s.off(y), k.disconnect.menuObserver(), k.disconnect.selectObserver()
                },
                observeChanges: function() {
                ...
                observe: {
                    select: function() {
                        k.has.input() && w.observe(U[0], {
                            childList: !0,
                            subtree: !0
                        })
                    },
                    menu: function() {
                        k.has.menu() && C.observe(_[0], {
                            childList: !0,
                            subtree: !0
                        })
                    }
                ...
                create: {
                    ...
                    userChoice: function(t) {
                        ...
                        return !!(t = t || k.get.userValues()) && (t = e.isArray(t) ? t : [t], e.each(t, function(t, a) {
                            !1 === k.get.item(a) && (r = T.templates.addition(k.add.variables(A.addResult, a)), o = e("<div />").html(r).attr("data-" + D.value, a).attr("data-" + D.text, a).addClass(S.addition).addClass(S.item), T.hideAdditions && o.addClass(S.hidden), n = n === i ? o : n.add(o), k.verbose("Creating user choices for value", a, o))
                        }), n)
                    },
                    ...
                    menu: function() {
                        _ = e("<div />").addClass(S.menu).appendTo(M)
                    },
                    sizer: function() {
                        z = e("<span />").addClass(S.sizer).insertAfter($)
                    }
                },
                search: function(e) {
                ...
                select: {
                    firstUnfiltered: function() {
                        k.verbose("Selecting first non-filtered element"), k.remove.selectedItem(), B.not(P.unselectable).not(P.addition + P.hidden).eq(0).addClass(S.selected)
                    },
                    nextAvailable: function(e) {
                        e = e.eq(0);
                        var t = e.nextAll(P.item).not(P.unselectable).eq(0),
                            n = e.prevAll(P.item).not(P.unselectable).eq(0);
                        t.length > 0 ? (k.verbose("Moving selection to", t), t.addClass(S.selected)) : (k.verbose("Moving selection to", n), n.addClass(S.selected))
                    }
                },
                setup: {
                    api: function() {
                    ...
                    layout: function() {
                        M.is("select") && (k.setup.select(), k.setup.returnedObject()), k.has.menu() || k.create.menu(), k.is.search() && !k.has.search() && (k.verbose("Adding search input"), $ = e("<input />").addClass(S.search).prop("autocomplete", "off").insertBefore(H)), k.is.multiple() && k.is.searchSelection() && !k.has.sizer() && k.create.sizer(), T.allowTab && k.set.tabbable()
                    },
                    select: function() {
                        var t = k.get.selectValues();
                        k.debug("Dropdown initialized on a select", t), M.is("select") && (U = M), U.parent(P.dropdown).length > 0 ? (k.debug("UI dropdown already exists. Creating dropdown menu only"), M = U.closest(P.dropdown), k.has.menu() || k.create.menu(), _ = M.children(P.menu), k.setup.menu(t)) : (k.debug("Creating entire dropdown from select"), M = e("<div />").attr("class", U.attr("class")).addClass(S.selection).addClass(S.dropdown).html(q.dropdown(t)).insertBefore(U), U.hasClass(S.multiple) && !1 === U.prop("multiple") && (k.error(L.missingMultiple), U.prop("multiple", !0)), U.is("[multiple]") && k.set.multiple(), U.prop("disabled") && (k.debug("Disabling dropdown"), M.addClass(S.disabled)), U.removeAttr("class").detach().prependTo(M)), k.refresh()
                    },
                    menu: function(e) {
                        _.html(q.menu(e, E)), B = _.find(P.item)
                    },
                    reference: function() {
                        k.debug("Dropdown behavior was called on select, replacing with closest dropdown"), M = M.parent(P.dropdown), k.refresh(), k.setup.returnedObject(), p && (G = k, k.invoke(f))
                    },
                ...
                refreshSelectors: function() {
                    k.verbose("Refreshing selector cache"), H = M.find(P.text), $ = M.find(P.search), U = M.find(P.input), V = M.find(P.icon), W = M.prev().find(P.text).length > 0 ? M.prev().find(P.text) : M.prev(), _ = M.children(P.menu), B = _.find(P.item)
                },
                refreshData: function() {
                    k.verbose("Refreshing cached metadata"), B.removeData(D.text).removeData(D.value)
                },
                clearData: function() {
                    k.verbose("Clearing metadata"), B.removeData(D.text).removeData(D.value), M.removeData(D.defaultText).removeData(D.defaultValue).removeData(D.placeholderText)
                },
                toggle: function() {
                ...
                show: function(t) {
                    if (t = e.isFunction(t) ? t : function() {}, k.can.show() && !k.is.active()) {
                        ...
                        !1 !== T.onShow.call(J) && k.animate.show(function() {
                            k.can.click() && k.bind.intent(), k.has.menuSearch() && k.focusSearch(), k.set.visible(), t.call(J)
                        })
                    }
                },
                hide: function(t) {
                    t = e.isFunction(t) ? t : function() {}, k.is.active() && (k.debug("Hiding dropdown"), !1 !== T.onHide.call(J) && k.animate.hide(function() {
                        k.remove.visible(), t.call(J)
                    }))
                },
                hideOthers: function() {
                    k.verbose("Finding other dropdowns to hide"), a.not(M).has(P.menu + "." + S.visible).dropdown("hide")
                },
                hideMenu: function() {
                    k.verbose("Hiding menu  instantaneously"), k.remove.active(), k.remove.visible(), _.transition("hide")
                },
                hideSubMenus: function() {
                    var e = _.children(P.item).find(P.menu);
                ...
                bind: {
                    ...
                    touchEvents: function() {
                        k.debug("Touch device detected binding additional touch events"), k.is.searchSelection() || k.is.single() && M.on("touchstart" + N, k.event.test.toggle), _.on("touchstart" + N, P.item, k.event.item.mouseenter)
                    },
                    keyboardEvents: function() {
                        k.verbose("Binding keyboard events"), M.on("keydown" + N, k.event.keydown), k.has.search() && M.on(k.get.inputEvent() + N, P.search, k.event.input), k.is.multiple() && s.on("keydown" + y, k.event.document.keydown)
                    },
                    inputEvents: function() {
                        k.verbose("Binding input change events"), M.on("change" + N, P.input, k.event.change)
                    },
                    mouseEvents: function() {
                        k.verbose("Binding mouse events"), k.is.multiple() && M.on("click" + N, P.label, k.event.label.click).on("click" + N, P.remove, k.event.remove.click), k.is.searchSelection() ? (M.on("mousedown" + N, k.event.mousedown).on("mouseup" + N, k.event.mouseup).on("mousedown" + N, P.menu, k.event.menu.mousedown).on("mouseup" + N, P.menu, k.event.menu.mouseup).on("click" + N, P.icon, k.event.icon.click).on("focus" + N, P.search, k.event.search.focus).on("click" + N, P.search, k.event.search.focus).on("blur" + N, P.search, k.event.search.blur).on("click" + N, P.text, k.event.text.focus), k.is.multiple() && M.on("click" + N, k.event.click)) : ("click" == T.on ? M.on("click" + N, P.icon, k.event.icon.click).on("click" + N, k.event.test.toggle) : "hover" == T.on ? M.on("mouseenter" + N, k.delay.show).on("mouseleave" + N, k.delay.hide) : M.on(T.on + N, k.toggle), M.on("mousedown" + N, k.event.mousedown).on("mouseup" + N, k.event.mouseup).on("focus" + N, k.event.focus).on("blur" + N, k.event.blur)), _.on("mouseenter" + N, P.item, k.event.item.mouseenter).on("mouseleave" + N, P.item, k.event.item.mouseleave).on("click" + N, P.item, k.event.item.click)
                    },
                    intent: function() {
                ...
                filter: function(e) {
                    ...
                    T.useLabels && k.has.maxSelections() || (T.apiSettings ? k.can.useAPI() ? k.queryRemote(t, function() {
                        n()
                    }) : k.error(L.noAPI) : (k.filterItems(t), n()))
                },
                queryRemote: function(t, n) {
                    ...
                    M.api("get request") || k.setup.api(), i = e.extend(!0, {}, i, T.apiSettings), M.api("setting", i).api("query")
                },
                filterItems: function(t) {
                    var n = t !== i ? t : k.get.query(),
                        ...
                        r = k.escape.regExp(n),
                        a = new RegExp("^" + r, "igm");
                    k.has.query() && (o = [], k.verbose("Searching for matching values", n), B.each(function() {
                        var t, i, r = e(this);
                        if ("both" == T.match || "text" == T.match) {
                            if (t = String(k.get.choiceText(r, !1)), -1 !== t.search(a)) return o.push(this), !0;
                            if ("exact" === T.fullTextSearch && k.exactSearch(n, t)) return o.push(this), !0;
                            if (!0 === T.fullTextSearch && k.fuzzySearch(n, t)) return o.push(this), !0
                        }
                        if ("both" == T.match || "value" == T.match) {
                            if (i = String(k.get.choiceValue(r, t)), -1 !== i.search(a)) return o.push(this), !0;
                            if (T.fullTextSearch && k.fuzzySearch(n, i)) return o.push(this), !0
                        }
                    })), k.debug("Showing only matched items", n), k.remove.filteredItem(), o && B.not(o).addClass(S.filtered)
                },
                ...
                filterActive: function() {
                    T.useLabels && B.filter("." + S.active).addClass(S.filtered)
                },
                focusSearch: function(e) {
                    k.has.search() && !k.is.focusedOnSearch() && (e ? (M.off("focus" + N, P.search), $.focus(), M.on("focus" + N, P.search, k.event.search.focus)) : $.focus())
                },
                forceSelection: function() {
                    var e = B.not(S.filtered).filter("." + S.selected).eq(0),
                        t = B.not(S.filtered).filter("." + S.active).eq(0),
                        n = e.length > 0 ? e : t;
                    return n.length > 0 ? (k.debug("Forcing partial selection to selected item", n), void k.event.item.click.call(n, {}, !0)) : void(T.allowAdditions ? (k.set.selected(k.get.query()), k.remove.searchTerm()) : k.remove.searchTerm())
                },
                event: {
                    change: function() {
                        Q || (k.debug("Input changed, updating selection"), k.set.selected())
                    },
                    focus: function() {
                        T.showOnFocus && !X && k.is.hidden() && !v && k.show()
                    },
                    blur: function(e) {
                        v = n.activeElement === this, X || v || (k.remove.activeLabel(), k.hide())
                    },
                    mousedown: function() {
                        k.is.searchSelection() ? b = !0 : X = !0
                    },
                    mouseup: function() {
                        k.is.searchSelection() ? b = !1 : X = !1
                    },
                    click: function(t) {
                    ...
                    search: {
                        ...
                        blur: function(e) {
                            v = n.activeElement === this, b || K || v || (T.forceSelection && k.forceSelection(), k.hide()), b = !1
                        }
                    },
                    icon: {
                        click: function(e) {
                    ...
                    label: {
                        click: function(t) {
                            ...
                            t.shiftKey ? (o.removeClass(S.active), s.addClass(S.active)) : t.ctrlKey ? n.toggleClass(S.active) : (o.removeClass(S.active), n.addClass(S.active)), T.onLabelSelect.apply(this, i.filter("." + S.active))
                        }
                    },
                    remove: {
                        click: function() {
                    ...
                    menu: {
                        mutation: function(t) {
                            var n = t[0],
                                ...
                                r = i.add(o),
                                a = r.is(P.addition) || r.closest(P.addition).length > 0,
                                s = r.is(P.message) || r.closest(P.message).length > 0;
                    ...
                    item: {
                        mouseenter: function(t) {
                            var n = e(t.target),
                                i = e(this),
                                o = i.children(P.menu),
                                r = i.siblings(P.item).children(P.menu),
                                a = o.length > 0;
                            !(o.find(n).length > 0) && a && (clearTimeout(k.itemTimer), k.itemTimer = setTimeout(function() {
                                k.verbose("Showing sub-menu", o), e.each(r, function() {
                        ...
                        click: function(t, n) {
                            var i = e(this),
                                ...
                                l = r.length > 0;
                            r.find(o).length > 0 || l && !T.allowCategorySelection || (k.is.searchSelection() && (T.allowAdditions && k.remove.userAddition(), k.remove.searchTerm(), k.is.focusedOnSearch() || 1 == n || k.focusSearch(!0)), T.useLabels || (k.remove.filteredItem(), k.set.scrollPosition(i)), k.determine.selectAction.call(this, a, s))
                        }
                    },
                    document: {
                        keydown: function(e) {
                            var t = e.which;
                            if (k.is.inObject(t, j)) {
                                var n = M.find(P.label),
                                    i = n.filter("." + S.active),
                                    ...
                                    f = k.is.focused(),
                                    p = d && 0 === k.get.caretPosition();
                                if (u && !a && !d) return;
                                t == j.leftArrow ? !f && !p || a ? a && (e.shiftKey ? k.verbose("Adding previous label to selection") : (k.verbose("Selecting previous label"), n.removeClass(S.active)), l && !s ? i.addClass(S.active) : i.prev(P.siblingLabel).addClass(S.active).end(), e.preventDefault()) : (k.verbose("Selecting previous label"), n.last().addClass(S.active)) : t == j.rightArrow ? (f && !a && n.first().addClass(S.active), a && (e.shiftKey ? k.verbose("Adding next label to selection") : (k.verbose("Selecting next label"), n.removeClass(S.active)), c ? u ? d ? n.removeClass(S.active) : k.focusSearch() : s ? i.next(P.siblingLabel).addClass(S.active) : i.addClass(S.active) : i.next(P.siblingLabel).addClass(S.active), e.preventDefault())) : t == j.deleteKey || t == j.backspace ? a ? (k.verbose("Removing active labels"), c && u && !d && k.focusSearch(), i.last().next(P.siblingLabel).addClass(S.active), k.remove.activeLabels(i), e.preventDefault()) : p && !a && t == j.backspace && (k.verbose("Removing last label on input backspace"), i = n.last().addClass(S.active), k.remove.activeLabels(i)) : i.removeClass(S.active)
                            }
                        }
                    },
                    keydown: function(e) {
                        var t = e.which;
                        if (k.is.inObject(t, j)) {
                            var n, i = B.not(P.unselectable).filter("." + S.selected).eq(0),
                                o = _.children("." + S.active).eq(0),
                                r = i.length > 0 ? i : o,
                                a = r.length > 0 ? r.siblings(":not(." + S.filtered + ")").addBack() : _.children(":not(." + S.filtered + ")"),
                                s = r.children(P.menu),
                                l = r.closest(P.menu),
                                c = l.hasClass(S.visible) || l.hasClass(S.animating) || l.parent(P.menu).length > 0,
                                u = s.length > 0,
                                d = r.length > 0,
                                f = r.not(P.unselectable).length > 0,
                                p = t == j.delimiter && T.allowAdditions && k.is.multiple();
                            if (T.allowAdditions && T.hideAdditions && (t == j.enter || p) && f && (k.verbose("Selecting item from keyboard shortcut", r), k.event.item.click.call(r, e), k.is.searchSelection() && k.remove.searchTerm()), k.is.visible()) {
                                if ((t == j.enter || p) && (t == j.enter && d && u && !T.allowCategorySelection ? (k.verbose("Pressed enter on unselectable category, opening sub menu"), t = j.rightArrow) : f && (k.verbose("Selecting item from keyboard shortcut", r), k.event.item.click.call(r, e), k.is.searchSelection() && k.remove.searchTerm()), e.preventDefault()), d && (t == j.leftArrow && l[0] !== _[0] && (k.verbose("Left key pressed, closing sub-menu"), k.animate.hide(!1, l), r.removeClass(S.selected), l.closest(P.item).addClass(S.selected), e.preventDefault()), t == j.rightArrow && u && (k.verbose("Right key pressed, opening sub-menu"), k.animate.show(!1, s), r.removeClass(S.selected), s.find(P.item).eq(0).addClass(S.selected), e.preventDefault())), t == j.upArrow) {
                                    if (n = d && c ? r.prevAll(P.item + ":not(" + P.unselectable + ")").eq(0) : B.eq(0), a.index(n) < 0) return k.verbose("Up key pressed but reached top of current menu"), void e.preventDefault();
                                    k.verbose("Up key pressed, changing active item"), r.removeClass(S.selected), n.addClass(S.selected), k.set.scrollPosition(n), T.selectOnKeydown && k.is.single() && k.set.selectedItem(n), e.preventDefault()
                                }
                                if (t == j.downArrow) {
                                    if (n = d && c ? n = r.nextAll(P.item + ":not(" + P.unselectable + ")").eq(0) : B.eq(0), 0 === n.length) return k.verbose("Down key pressed but reached bottom of current menu"), void e.preventDefault();
                                    k.verbose("Down key pressed, changing active item"), B.removeClass(S.selected), n.addClass(S.selected), k.set.scrollPosition(n), T.selectOnKeydown && k.is.single() && k.set.selectedItem(n), e.preventDefault()
                                }
                                t == j.pageUp && (k.scrollPage("up"), e.preventDefault()), t == j.pageDown && (k.scrollPage("down"), e.preventDefault()), t == j.escape && (k.verbose("Escape key pressed, closing dropdown"), k.hide())
                            } else p && e.preventDefault(), t != j.downArrow || k.is.visible() || (k.verbose("Down key pressed, showing dropdown"), k.select.firstUnfiltered(), k.show(), e.preventDefault())
                ...
                determine: {
                    selectAction: function(t, n) {
                        k.verbose("Determining action", T.action), e.isFunction(k.action[T.action]) ? (k.verbose("Triggering preset action", T.action, t, n), k.action[T.action].call(J, t, n, this)) : e.isFunction(T.action) ? (k.verbose("Triggering user action", T.action, t, n), T.action.call(J, t, n, this)) : k.error(L.action, T.action)
                    },
                    eventInModule: function(t, i) {
                        var o = e(t.target),
                            r = o.closest(n.documentElement).length > 0,
                            a = o.closest(M).length > 0;
                ...
                get: {
                    ...
                    defaultText: function() {
                        return M.data(D.defaultText)
                    },
                    defaultValue: function() {
                        return M.data(D.defaultValue)
                    },
                    placeholderText: function() {
                        return M.data(D.placeholderText) || ""
                    },
                    text: function() {
                        return H.text()
                    },
                    ...
                    searchWidth: function(e) {
                        return e = e !== i ? e : $.val(), z.text(e), Math.ceil(z.width() + 1)
                    },
                    selectionCount: function() {
                        var t = k.get.values();
                        return k.is.multiple() ? e.isArray(t) ? t.length : 0 : "" !== k.get.value() ? 1 : 0
                    },
                    ...
                    value: function() {
                        var t = U.length > 0 ? U.val() : M.data(D.value),
                    ...
                    choiceText: function(t, n) {
                        if (n = n !== i ? n : T.preserveHTML, t) return t.find(P.menu).length > 0 && (k.verbose("Retrieving text of element with sub-menu"), t = t.clone(), t.find(P.menu).remove(), t.find(P.menuIcon).remove()), t.data(D.text) !== i ? t.data(D.text) : n ? e.trim(t.html()) : e.trim(t.text())
                    },
                    choiceValue: function(t, n) {
                        return n = n || k.get.choiceText(t), !!t && (t.data(D.value) !== i ? String(t.data(D.value)) : "string" == typeof n ? e.trim(n.toLowerCase()) : String(n))
                    },
                    inputEvent: function() {
                        var e = $[0];
                    ...
                    selectedItem: function() {
                        var e = B.not(P.unselectable).filter("." + S.selected);
                    ...
                    item: function(t, n) {
                        var o, r, a = !1;
                        return t = t !== i ? t : k.get.values() !== i ? k.get.values() : k.get.text(), o = r ? t.length > 0 : t !== i && null !== t, r = k.is.multiple() && e.isArray(t), n = "" === t || 0 === t || n || !1, o && B.each(function() {
                            var o = e(this),
                                s = k.get.choiceText(o),
                                l = k.get.choiceValue(o, s);
                            if (null !== l && l !== i)
                                if (r) - 1 === e.inArray(String(l), t) && -1 === e.inArray(s, t) || (a = a ? a.add(o) : o);
                                else if (n) {
                                if (k.verbose("Ambiguous dropdown value using strict type check", o, t), l === t || s === t) return a = o, !0
                            } else if (String(l) == String(t) || s == t) return k.verbose("Found select item by value", l, t), a = o, !0
                        }), a
                    }
                },
                check: {
                    maxSelections: function(e) {
                        return !T.maxSelections || (e = e !== i ? e : k.get.selectionCount(), e >= T.maxSelections ? (k.debug("Maximum selection count reached"), T.useLabels && (B.addClass(S.filtered), k.add.message(A.maxSelections)), !0) : (k.verbose("No longer at maximum selection count"), k.remove.message(), k.remove.filteredItem(), k.is.searchSelection() && k.filterItems(), !1))
                    }
                },
                restore: {
                    defaults: function() {
                    ...
                    defaultText: function() {
                        ...
                        e === k.get.placeholderText ? (k.debug("Restoring default placeholder text", e), k.set.placeholderText(e)) : (k.debug("Restoring default text", e), k.set.text(e))
                    },
                    placeholderText: function() {
                    ...
                    labels: function() {
                        T.allowAdditions && (T.useLabels || (k.error(L.labels), T.useLabels = !0), k.debug("Restoring selected values"), k.create.userLabels()), k.check.maxSelections()
                    },
                    selected: function() {
                ...
                read: {
                    remoteData: function(e) {
                        var n;
                        return t.Storage === i ? void k.error(L.noStorage) : (n = sessionStorage.getItem(e)) !== i && n
                    }
                },
                save: {
                    defaults: function() {
                    ...
                    defaultValue: function() {
                        var e = k.get.value();
                        k.verbose("Saving default value as", e), M.data(D.defaultValue, e)
                    },
                    defaultText: function() {
                        var e = k.get.text();
                        k.verbose("Saving default text as", e), M.data(D.defaultText, e)
                    },
                    placeholderText: function() {
                        var e;
                        !1 !== T.placeholder && H.hasClass(S.placeholder) && (e = k.get.text(), k.verbose("Saving placeholder text as", e), M.data(D.placeholderText, e))
                    },
                    remoteData: function(e, n) {
                        return t.Storage === i ? void k.error(L.noStorage) : (k.verbose("Saving remote data to session storage", n, e), void sessionStorage.setItem(n, e))
                    }
                },
                clear: function() {
                ...
                scrollPage: function(e, t) {
                    var n, i, o, r = t || k.get.selectedItem(),
                        a = r.closest(P.menu),
                        s = a.outerHeight(),
                        l = a.scrollTop(),
                        ...
                        f = B.not(P.unselectable);
                    o = "up" == e ? f.index(r) - u : f.index(r) + u, n = "up" == e ? o >= 0 : o < f.length, i = n ? f.eq(o) : "up" == e ? f.first() : f.last(), i.length > 0 && (k.debug("Scrolling page", e, i), r.removeClass(S.selected), i.addClass(S.selected), T.selectOnKeydown && k.is.single() && k.set.selectedItem(i), a.scrollTop(d))
                },
                set: {
                    filtered: function() {
                        var e = k.is.multiple(),
                            ...
                            r = k.get.searchWidth(),
                            a = "" !== i;
                        e && o && (k.verbose("Adjusting input width", r, T.glyphWidth), $.css("width", r)), o || n && a ? (k.verbose("Hiding placeholder text"), H.addClass(S.filtered)) : (!e || n && !a) && (k.verbose("Showing placeholder text"), H.removeClass(S.filtered))
                    },
                    empty: function() {
                        M.addClass(S.empty)
                    },
                    ...
                    placeholderText: function(e) {
                        e = e || k.get.placeholderText(), k.debug("Setting placeholder text", e), k.set.text(e), H.addClass(S.placeholder)
                    },
                    tabbable: function() {
                        k.has.search() ? (k.debug("Added tabindex to searchable dropdown"), $.val("").attr("tabindex", 0), _.attr("tabindex", -1)) : (k.debug("Added tabindex to dropdown"), M.attr("tabindex") === i && (M.attr("tabindex", 0), _.attr("tabindex", -1)))
                    },
                    initialLoad: function() {
                        k.verbose("Setting initial load"), m = !0
                    },
                    activeItem: function(e) {
                        T.allowAdditions && e.filter(P.addition).length > 0 ? e.addClass(S.filtered) : e.addClass(S.active)
                    },
                    ...
                    scrollPosition: function(e, t) {
                        var n, o, r, a, s, l, c, u, d;
                        e = e || k.get.selectedItem(), n = e.closest(P.menu), o = e && e.length > 0, t = t !== i && t, e && n.length > 0 && o && (a = e.position().top, n.addClass(S.loading), l = n.scrollTop(), s = n.offset().top, a = e.offset().top, r = l - s + a, t || (c = n.height(), d = l + c < r + 5, u = r - 5 < l), k.debug("Scrolling to active item", r), (t || u || d) && n.scrollTop(r), n.removeClass(S.loading))
                    },
                    text: function(e) {
                        "select" !== T.action && ("combo" == T.action ? (k.debug("Changing combo button text", e, W), T.preserveHTML ? W.html(e) : W.text(e)) : (e !== k.get.placeholderText() && H.removeClass(S.placeholder), k.debug("Changing text", e, H), H.removeClass(S.filtered), T.preserveHTML ? H.html(e) : H.text(e)))
                    },
                    ...
                    selectedLetter: function(t) {
                        var n, i = B.filter("." + S.selected),
                            ...
                            r = !1;
                        o && (n = i.nextAll(B).eq(0), k.has.firstLetter(n, t) && (r = n)), r || B.each(function() {
                            if (k.has.firstLetter(e(this), t)) return r = e(this), !1
                    ...
                    value: function(e, t, n) {
                        var o = k.escape.value(e),
                            ...
                            s = e !== i ? String(e) : e;
                        if (r) {
                            if (!T.allowReselection && s == a && (k.verbose("Skipping value update already same value", e, a), !k.is.initialLoad())) return;
                            k.is.single() && k.has.selectInput() && k.can.extendSelect() && (k.debug("Adding user option", e), k.add.optionValue(e)), k.debug("Updating input value", o, a), Q = !0, U.val(o), !1 === T.fireOnInit && k.is.initialLoad() ? k.debug("Input native change event ignored on initial load") : k.trigger.change(), Q = !1
                        } else k.verbose("Storing value in metadata", o, U), o !== a && M.data(D.value, s);
                        !1 === T.fireOnInit && k.is.initialLoad() ? k.verbose("No callback on initial load", T.onChange) : T.onChange.call(J, e, t, n)
                    },
                    active: function() {
                        M.addClass(S.active)
                    },
                    ...
                    selected: function(t, n) {
                        var i = k.is.multiple();
                        (n = T.allowAdditions ? n || k.get.itemWithAdditions(t) : n || k.get.item(t)) && (k.debug("Setting selected menu item to", n), k.is.multiple() && k.remove.searchWidth(), k.is.single() ? (k.remove.activeItem(), k.remove.selectedItem()) : T.useLabels && k.remove.selectedItem(), n.each(function() {
                            var t = e(this),
                ...
                add: {
                    label: function(t, n, i) {
                        var o, r = k.is.searchSelection() ? $ : H,
                            a = k.escape.value(t);
                        return o = e("<a />").addClass(S.label).attr("data-value", a).html(q.label(a, n)), o = T.onLabelCreate.call(o, a, n), k.has.label(t) ? void k.debug("Label already exists, skipping", a) : (T.label.variation && o.addClass(T.label.variation), void(!0 === i ? (k.debug("Animating in label", o), o.addClass(S.hidden).insertBefore(r).transition(T.label.transition, T.label.duration)) : (k.debug("Adding selection label", o), o.insertBefore(r))))
                    },
                    message: function(t) {
                        var n = _.children(P.message),
                            i = T.templates.message(k.add.variables(t));
                        n.length > 0 ? n.html(i) : n = e("<div/>").html(i).addClass(S.message).appendTo(_)
                    },
                    optionValue: function(t) {
                        var n = k.escape.value(t);
                        U.find('option[value="' + n + '"]').length > 0 || (k.disconnect.selectObserver(), k.is.single() && (k.verbose("Removing previous user addition"), U.find("option." + S.addition).remove()), e("<option/>").prop("value", n).addClass(S.addition).html(t).appendTo(U), k.verbose("Adding user addition as an <option>", t), k.observe.select())
                    },
                    userSuggestion: function(e) {
                        var t, n = _.children(P.addition),
                            i = k.get.item(e),
                            o = i && i.not(P.addition).length,
                            r = n.length > 0;
                        if (!T.useLabels || !k.has.maxSelections()) {
                            if ("" === e || o) return void n.remove();
                            r ? (n.data(D.value, e).data(D.text, e).attr("data-" + D.value, e).attr("data-" + D.text, e).removeClass(S.filtered), T.hideAdditions || (t = T.templates.addition(k.add.variables(A.addResult, e)), n.html(t)), k.verbose("Replacing user suggestion with new value", n)) : (n = k.create.userChoice(e), n.prependTo(_), k.verbose("Adding item choice to menu corresponding with user choice addition", n)), T.hideAdditions && !k.is.allFiltered() || n.addClass(S.selected).siblings().removeClass(S.selected), k.refreshItems()
                        }
                    },
                    ...
                    value: function(t, n, i) {
                        var o, r = k.get.values();
                        return "" === t ? void k.debug("Cannot select blank values from multiselect") : (e.isArray(r) ? (o = r.concat([t]), o = k.get.uniqueArray(o)) : o = [t], k.has.selectInput() ? k.can.extendSelect() && (k.debug("Adding value to select", t, o, U), k.add.optionValue(t)) : (o = o.join(T.delimiter), k.debug("Setting hidden input to delimited value", o, U)), !1 === T.fireOnInit && k.is.initialLoad() ? k.verbose("Skipping onadd callback on initial load", T.onAdd) : T.onAdd.call(J, t, n, i), k.set.value(o, t, n, i), void k.check.maxSelections())
                    }
                },
                remove: {
                    active: function() {
                    ...
                    activeLabel: function() {
                        M.find(P.label).removeClass(S.active)
                    },
                    empty: function() {
                    ...
                    filteredItem: function() {
                        T.useLabels && k.has.maxSelections() || (T.useLabels && k.is.multiple() ? B.not("." + S.active).removeClass(S.filtered) : B.removeClass(S.filtered), k.remove.empty())
                    },
                    optionValue: function(e) {
                        var t = k.escape.value(e),
                            n = U.find('option[value="' + t + '"]');
                        n.length > 0 && n.hasClass(S.addition) && (w && (w.disconnect(), k.verbose("Temporarily disconnecting mutation observer")), n.remove(), k.verbose("Removing user addition as an <option>", t), w && w.observe(U[0], {
                            childList: !0,
                            subtree: !0
                        }))
                    },
                    message: function() {
                        _.children(P.message).remove()
                    },
                    searchWidth: function() {
                        $.css("width", "")
                    },
                    searchTerm: function() {
                        k.verbose("Cleared search term"), $.val(""), k.set.filtered()
                    },
                    userAddition: function() {
                        B.filter(P.addition).remove()
                    },
                    selected: function(t, n) {
                    ...
                    value: function(e, t, n) {
                        ...
                        k.has.selectInput() ? (k.verbose("Input is <select> removing selected option", e), i = k.remove.arrayValue(e, o), k.remove.optionValue(e)) : (k.verbose("Removing from delimited values", e), i = k.remove.arrayValue(e, o), i = i.join(T.delimiter)), !1 === T.fireOnInit && k.is.initialLoad() ? k.verbose("No callback on initial load", T.onRemove) : T.onRemove.call(J, e, t, n), k.set.value(i, t, n), k.check.maxSelections()
                    },
                    ...
                    activeLabels: function(e) {
                        e = e || M.find(P.label).filter("." + S.active), k.verbose("Removing active label selections", e), k.remove.labels(e)
                    },
                    labels: function(t) {
                        t = t || M.find(P.label), k.verbose("Removing labels", t), t.each(function() {
                            var t = e(this),
                                n = t.data(D.value),
                                o = n !== i ? String(n) : n,
                                r = k.is.userValue(o);
                            return !1 === T.onLabelRemove.call(t, n) ? void k.debug("Label remove callback cancelled removal") : (k.remove.message(), void(r ? (k.remove.value(o), k.remove.label(o)) : k.remove.selected(o)))
                        })
                    },
                    tabbable: function() {
                        k.has.search() ? (k.debug("Searchable dropdown initialized"), $.removeAttr("tabindex"), _.removeAttr("tabindex")) : (k.debug("Simple selection dropdown initialized"), M.removeAttr("tabindex"), _.removeAttr("tabindex"))
                    }
                },
                has: {
                    menuSearch: function() {
                        return k.has.search() && $.closest(_).length > 0
                    },
                    search: function() {
                        return $.length > 0
                    },
                    ...
                    message: function() {
                        return 0 !== _.children(P.message).length
                    },
                    label: function(e) {
                        var t = k.escape.value(e);
                        return M.find(P.label).filter('[data-value="' + t + '"]').length > 0
                    },
                    maxSelections: function() {
                        return T.maxSelections && k.get.selectionCount() >= T.maxSelections
                    },
                    allResultsFiltered: function() {
                        var e = B.not(P.addition);
                        return e.filter(P.unselectable).length === e.length
                    },
                    userSuggestion: function() {
                        return _.children(P.addition).length > 0
                    },
                    query: function() {
                        return "" !== k.get.query()
                    },
                ...
                is: {
                    ...
                    alreadySetup: function() {
                        return M.is("select") && M.parent(P.dropdown).length > 0 && 0 === M.prev().length
                    },
                    ...
                    searchSelection: function() {
                        return k.has.search() && 1 === $.parent(P.dropdown).length
                    },
                    selection: function() {
                    ...
                    visible: function(e) {
                        return e ? e.hasClass(S.visible) : _.hasClass(S.visible)
                    }
                },
                can: {
                    activate: function(e) {
                ...
                animate: {
                    show: function(t, n) {
                        ...
                        t = e.isFunction(t) ? t : function() {}, k.verbose("Doing menu show animation", r), k.set.direction(n), o = k.get.transition(n), k.is.selection() && k.set.scrollPosition(k.get.selectedItem(), !0), (k.is.hidden(r) || k.is.animating(r)) && ("none" == o ? (a(), r.transition("show"), t.call(J)) : e.fn.transition !== i && M.transition("is supported") ? r.transition({
                            animation: o + " in",
                            debug: T.debug,
                            verbose: T.verbose,
                            duration: T.duration,
                        ...
                        }) : k.error(L.noTransition, o))
                    },
                    hide: function(t, n) {
                        var o = n || _,
                            r = (n ? T.duration : T.duration, n ? function() {} : function() {
                                k.can.click() && k.unbind.intent(), k.remove.active()
                            }),
                            a = k.get.transition(n);
                        t = e.isFunction(t) ? t : function() {}, (k.is.visible(o) || k.is.animating(o)) && (k.verbose("Doing menu hide animation", o), "none" == a ? (r(), o.transition("hide"), t.call(J)) : e.fn.transition !== i && M.transition("is supported") ? o.transition({
                            animation: a + " out",
                            duration: T.duration,
                            debug: T.debug,
                            verbose: T.verbose,
                            ...
                            onStart: r,
                            onComplete: function() {
                                "auto" == T.direction && k.remove.upward(n), t.call(J)
                            }
                        }) : k.error(L.transition))
                    }
                },
                ...
                invoke: function(t, n, o) {
                    var a, s, l, c = G;
                    return n = n || g, o = J || o, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function(n, o) {
                        var r = n != a ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(c[r]) && n != a) c = c[r];
                        else {
                            if (c[r] !== i) return s = c[r], !1;
                            if (!e.isPlainObject(c[o]) || n == a) return c[o] !== i ? (s = c[o], !1) : (k.error(L.method, t), !1);
                            c = c[o]
                        }
                    })), e.isFunction(s) ? l = s.apply(o, n) : s !== i && (l = s), e.isArray(r) ? r.push(l) : r !== i ? r = [r, l] : l !== i && (r = l), s
                }
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.embed = function(n) {
        ...
        return r.each(function() {
            ...
            f = {
                ...
                instantiate: function() {
                    f.verbose("Storing instance of module", f), j = f, k.data(C, f)
                },
                destroy: function() {
                ...
                bind: {
                    events: function() {
                        f.has.placeholder() && (f.debug("Adding placeholder events"), k.on("click" + w, g.placeholder, f.createAndShow).on("click" + w, g.icon, f.createAndShow))
                    }
                },
                create: function() {
                ...
                createPlaceholder: function(e) {
                    var t = f.get.icon(),
                        n = f.get.url();
                    f.generate.embed(n), e = e || f.get.placeholder(), k.html(x.placeholder(e, t)), f.debug("Creating placeholder for embed", e, t)
                },
                createEmbed: function(t) {
                    f.refresh(), t = t || f.get.url(), A = e("<div/>").addClass(h.embed).html(f.generate.embed(t)).appendTo(k), p.onCreate.call(E, t), f.debug("Creating embed object", A)
                },
                ...
                reset: function() {
                    f.debug("Clearing embed and showing placeholder"), f.remove.active(), f.remove.embed(), f.showPlaceholder(), p.onReset.call(E)
                },
                show: function() {
                    f.debug("Showing embed"), f.set.active(), p.onDisplay.call(E)
                },
                hide: function() {
                    f.debug("Hiding embed"), f.showPlaceholder()
                },
                showPlaceholder: function() {
                    f.debug("Showing placeholder image"), f.remove.active(), p.onPlaceholderDisplay.call(E)
                },
                get: {
                    id: function() {
                ...
                determine: {
                    ...
                    source: function(t) {
                        var n = !1;
                        return t = t || f.get.url(), t && e.each(m, function(e, i) {
                    ...
                    url: function() {
                        ...
                        return e = m[n] !== i && m[n].url.replace("{id}", t), e && k.data(b.url, e), e
                    }
                },
                set: {
                    active: function() {
                ...
                generate: {
                    ...
                    parameters: function(t, n) {
                        var o = m[t] && m[t].parameters !== i ? m[t].parameters(p) : {};
            ...
            }, u ? (j === i && f.initialize(), f.invoke(c)) : (j !== i && j.invoke("destroy"), f.initialize())
        }), o !== i ? o : this
    }, e.fn.embed.settings = {
        name: "Embed",
        namespace: "embed",
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.modal = function(o) {
        ...
        return a.each(function() {
            ...
            T = {
                initialize: function() {
                    T.verbose("Initializing dimmer", L), T.create.id(), T.create.dimmer(), T.refreshModals(), T.bind.events(), S.observeChanges && T.observeChanges(), T.instantiate()
                },
                instantiate: function() {
                    T.verbose("Storing instance of modal"), F = T, P.data(O, F)
                },
                create: {
                    dimmer: function() {
                        var t = {
                ...
                destroy: function() {
                    T.verbose("Destroying previous modal"), P.removeData(O).off(R), s.off(w), x.off(w), q.off(R), L.dimmer("destroy")
                },
                observeChanges: function() {
                ...
                refreshModals: function() {
                    v = P.siblings(A.modal), a = v.add(P)
                },
                attachEvents: function(t, n) {
                    var i = e(t);
                    n = e.isFunction(T[n]) ? T[n] : T.toggle, i.length > 0 ? (T.debug("Attaching modal events to element", t, n), i.off(R).on("click" + R, n)) : T.error(D.notFound, t)
                },
                bind: {
                    events: function() {
                        T.verbose("Attaching events"), P.on("click" + R, A.close, T.event.close).on("click" + R, A.approve, T.event.approve).on("click" + R, A.deny, T.event.deny), s.on("resize" + w, T.event.resize)
                    }
                },
                get: {
                    id: function() {
                ...
                event: {
                    approve: function() {
                        return !1 === S.onApprove.call(N, e(this)) ? void T.verbose("Approve callback returned false cancelling hide") : void T.hide()
                    },
                    deny: function() {
                        return !1 === S.onDeny.call(N, e(this)) ? void T.verbose("Deny callback returned false cancelling hide") : void T.hide()
                    },
                    close: function() {
                        T.hide()
                    },
                    ...
                    keyboard: function(e) {
                        27 == e.which && (S.closable ? (T.debug("Escape key pressed hiding modal"), T.hide()) : T.debug("Escape key pressed, but closable is set to false"), e.preventDefault())
                    },
                    resize: function() {
                        y.dimmer("is active") && m(T.refresh)
                    }
                },
                toggle: function() {
                ...
                showModal: function(t) {
                    t = e.isFunction(t) ? t : function() {}, T.is.animating() || !T.is.active() ? (T.showDimmer(), T.cacheSizes(), T.set.position(), T.set.screenHeight(), T.set.type(), T.set.clickaway(), !S.allowMultiple && T.others.active() ? T.hideOthers(T.showModal) : (S.onShow.call(N), S.transition && e.fn.transition !== i && P.transition("is supported") ? (T.debug("Showing modal with css animations"), P.transition({
                        debug: S.debug,
                        ...
                        useFailSafe: !0,
                        onComplete: function() {
                            S.onVisible.apply(N), S.keyboardShortcuts && T.add.keyboardShortcuts(), T.save.focus(), T.set.active(), S.autofocus && T.set.autofocus(), t()
                        }
                    })) : T.error(D.noTransition))) : T.debug("Modal is already visible")
                },
                hideModal: function(t, n) {
                    return t = e.isFunction(t) ? t : function() {}, T.debug("Hiding modal"), !1 === S.onHide.call(N, e(this)) ? void T.verbose("Hide callback returned false cancelling hide") : void((T.is.animating() || T.is.active()) && (S.transition && e.fn.transition !== i && P.transition("is supported") ? (T.remove.active(), P.transition({
                        debug: S.debug,
                        ...
                        useFailSafe: !0,
                        onStart: function() {
                            T.others.active() || n || T.hideDimmer(), S.keyboardShortcuts && T.remove.keyboardShortcuts()
                        },
                        onComplete: function() {
                            S.onHidden.call(N), T.restore.focus(), t()
                        }
                ...
                remove: {
                    ...
                    scrolling: function() {
                        y.removeClass(E.scrolling), P.removeClass(E.scrolling)
                    }
                },
                cacheSizes: function() {
                    var o = P.outerHeight();
                ...
                set: {
                    ...
                    scrolling: function() {
                        y.addClass(E.scrolling), P.addClass(E.scrolling)
                    },
                    type: function() {
                    ...
                    position: function() {
                        T.verbose("Centering modal on page", T.cache), T.can.fit() ? P.css({
                            top: "",
            ...
            }, g ? (F === i && T.initialize(), T.invoke(p)) : (F !== i && F.invoke("destroy"), T.initialize())
        }), r !== i ? r : this
    }, e.fn.modal.settings = {
        name: "Modal",
        namespace: "modal",
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.nag = function(n) {
        ...
        return r.each(function() {
            var r, f = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.nag.settings, n) : e.extend({}, e.fn.nag.settings),
                ...
                x = this,
                w = b.data(v);
            t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame, r = {
                initialize: function() {
                    r.verbose("Initializing element"), b.on("click" + m, p.close, r.dismiss).data(v, r), f.detachable && b.parent()[0] !== y[0] && b.detach().prependTo(y), f.displayTime > 0 && setTimeout(r.hide, f.displayTime), r.show()
                },
                destroy: function() {
                    r.verbose("Destroying instance"), b.removeData(v).off(m)
                },
                show: function() {
                ...
                storage: {
                    set: function(n, o) {
                        ...
                        else if ("sessionstorage" == f.storageMethod && t.sessionStorage !== i) t.sessionStorage.setItem(n, o), r.debug("Value stored using session storage", n, o);
                        else {
                            if (e.cookie === i) return void r.error(g.noCookieStorage);
                            e.cookie(n, o, a), r.debug("Value stored using cookie", n, o, a)
                        }
                    },
                    get: function(n, o) {
                        var a;
                        return "localstorage" == f.storageMethod && t.localStorage !== i ? a = t.localStorage.getItem(n) : "sessionstorage" == f.storageMethod && t.sessionStorage !== i ? a = t.sessionStorage.getItem(n) : e.cookie !== i ? a = e.cookie(n) : r.error(g.noCookieStorage), "undefined" != a && "null" != a && a !== i && null !== a || (a = i), a
                    },
                    remove: function(n) {
                        var o = r.get.storageOptions();
                        "localstorage" == f.storageMethod && t.localStorage !== i ? t.localStorage.removeItem(n) : "sessionstorage" == f.storageMethod && t.sessionStorage !== i ? t.sessionStorage.removeItem(n) : e.cookie !== i ? e.removeCookie(n, o) : r.error(g.noStorage)
                    }
                },
                setting: function(t, n) {
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.popup = function(o) {
        var r, a = e(this),
            ...
            h = [].slice.call(arguments, 1);
        return a.each(function() {
            var a, m, v, b, y, x, w = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.popup.settings, o) : e.extend({}, e.fn.popup.settings),
                C = w.selector,
                k = w.className,
                T = w.error,
                S = w.metadata,
            ...
            x = {
                initialize: function() {
                    x.debug("Initializing", D), x.createID(), x.bind.events(), !x.exists() && w.preserve && x.create(), w.observeChanges && x.observeChanges(), x.instantiate()
                },
                instantiate: function() {
                    x.verbose("Storing instance", x), I = x, D.data(j, I)
                },
                observeChanges: function() {
                    "MutationObserver" in t && (v = new MutationObserver(x.event.documentChanged), v.observe(n, {
                        childList: !0,
                        subtree: !0
                    }), x.debug("Setting up mutation observer", v))
                },
                refresh: function() {
                    w.popup ? a = e(w.popup).eq(0) : w.inline && (a = L.nextAll(C.popup).eq(0), w.popup = a), w.popup ? (a.addClass(k.loading), m = x.get.offsetParent(), a.removeClass(k.loading), w.movePopup && x.has.popup() && x.get.offsetParent(a)[0] !== m[0] && (x.debug("Moving popup to the same offset parent as activating element"), a.detach().appendTo(m))) : m = w.inline ? x.get.offsetParent(L) : x.has.popup() ? x.get.offsetParent(a) : c, m.is("html") && m[0] !== c[0] && (x.debug("Setting page as offset parent"), m = c), x.get.variation() && x.set.variation()
                },
                reposition: function() {
                    x.refresh(), x.set.position()
                },
                destroy: function() {
                    x.debug("Destroying previous module"), v && v.disconnect(), a && !w.preserve && x.removePopup(), clearTimeout(x.hideTimer), clearTimeout(x.showTimer), x.unbind.close(), x.unbind.events(), D.removeData(j)
                },
                event: {
                    start: function(t) {
                        var n = e.isPlainObject(w.delay) ? w.delay.show : w.delay;
                        clearTimeout(x.hideTimer), F || (x.showTimer = setTimeout(x.show, n))
                    },
                    end: function() {
                ...
                show: function(e) {
                    if (e = e || function() {}, x.debug("Showing pop-up", w.transition), x.is.hidden() && (!x.is.active() || !x.is.dropdown())) {
                        if (x.exists() || x.create(), !1 === w.onShow.call(a, M)) return void x.debug("onShow callback returned false, cancelling popup animation");
                ...
                hide: function(e) {
                    if (e = e || function() {}, x.is.visible() || x.is.animating()) {
                        if (!1 === w.onHide.call(a, M)) return void x.debug("onHide callback returned false, cancelling popup animation");
                ...
                exists: function() {
                    return !!a && (w.inline || w.popup ? x.has.popup() : a.closest(R).length >= 1)
                },
                removePopup: function() {
                    x.has.popup() && !w.popup && (x.debug("Removing popup", a), a.remove(), a = i, w.onRemove.call(a, M))
                },
                save: {
                    conditions: function() {
                        x.cache = {
                            title: D.attr("title")
                        }, x.cache.title && D.removeAttr("title"), x.verbose("Saving original attributes", x.cache.title)
                    }
                },
                restore: {
                    conditions: function() {
                        return x.cache && x.cache.title && (D.attr("title", x.cache.title), x.verbose("Restoring original attributes", x.cache.title)), !0
                    }
                },
                supports: {
                    svg: function() {
                ...
                animate: {
                    show: function(t) {
                        t = e.isFunction(t) ? t : function() {}, w.transition && e.fn.transition !== i && D.transition("is supported") ? (x.set.visible(), a.transition({
                            ...
                            duration: w.duration,
                            onComplete: function() {
                                x.bind.close(), t.call(a, M), w.onVisible.call(a, M)
                            }
                        })) : x.error(T.noTransition)
                    },
                    hide: function(t) {
                        return t = e.isFunction(t) ? t : function() {}, x.debug("Hiding pop-up"), !1 === w.onHide.call(a, M) ? void x.debug("onHide callback returned false, cancelling popup animation") : void(w.transition && e.fn.transition !== i && D.transition("is supported") ? a.transition({
                            ...
                            verbose: w.verbose,
                            onComplete: function() {
                                x.reset(), t.call(a, M), w.onHidden.call(a, M)
                            }
                        }) : x.error(T.noTransition))
                    }
                },
                ...
                get: {
                    html: function() {
                        return D.removeData(S.html), D.data(S.html) || w.html
                    },
                    title: function() {
                        return D.removeData(S.title), D.data(S.title) || w.title
                    },
                    content: function() {
                        return D.removeData(S.content), D.data(S.content) || D.attr("title") || w.content
                    },
                    variation: function() {
                        return D.removeData(S.variation), D.data(S.variation) || w.variation
                    },
                    popup: function() {
                        return a
                    },
                    ...
                    nextPosition: function(e) {
                        var t = e.split(" "),
                            ...
                            c = !1,
                            u = !1;
                        return N || (x.verbose("All available positions available"), N = x.get.positions()), x.debug("Recording last position tried", e), N[e] = !0, "opposite" === w.prefer && (u = [o[n], i], u = u.join(" "), l = !0 === N[u], x.debug("Trying opposite strategy", u)), "adjacent" === w.prefer && s && (u = [n, r[i]], u = u.join(" "), c = !0 === N[u], x.debug("Trying adjacent strategy", u)), (c || l) && (x.debug("Using backup position", u), u = a[e]), u
                    }
                },
                set: {
                    position: function(e, t) {
                        if (0 === L.length || 0 === a.length) return void x.error(T.notFound);
                        var n, o, r, s, l, c, u, d;
                        if (t = t || x.get.calculations(), e = e || D.data(S.position) || w.position, n = D.data(S.offset) || w.offset, o = w.distanceAway, r = t.target, s = t.popup, l = t.parent, 0 === r.width && 0 === r.height && !x.is.svg(r.element)) return x.debug("Popup target is hidden, no action taken"), !1;
                        ...
                        }), x.debug("RTL: Popup position updated", e)), q == w.maxSearchDepth && "string" == typeof w.lastResort && (e = w.lastResort), e) {
                            case "top left":
                                c = {
                                    top: "auto",
                        ...
                        if (c === i && x.error(T.invalidPosition, e), x.debug("Calculated popup positioning values", c), a.css(c).removeClass(k.position).addClass(e).addClass(k.loading), u = x.get.popupOffset(), d = x.get.distanceFromBoundary(u, t), x.is.offstage(d, e)) {
                            if (x.debug("Position is outside viewport", e), q < w.maxSearchDepth) return q++, e = x.get.nextPosition(e), x.debug("Trying new position", e), !!a && x.set.position(e, t);
                            if (!w.lastResort) return x.debug("Popup could not find a position to display", a), x.error(T.cannotPlace, M), x.remove.attempts(), x.remove.loading(), x.reset(), w.onUnplaceable.call(a, M), !1;
                ...
                remove: {
                    ...
                    visible: function() {
                        D.removeClass(k.visible)
                    },
                    attempts: function() {
                        x.verbose("Resetting all searched positions"), q = 0, N = !1
                    }
                },
                bind: {
                    events: function() {
                        x.debug("Binding popup events to module"), "click" == w.on && D.on("click" + E, x.toggle), "hover" == w.on && !0 && D.on("touchstart" + E, x.event.touchstart), x.get.startEvent() && D.on(x.get.startEvent() + E, x.event.start).on(x.get.endEvent() + E, x.event.end), w.target && x.debug("Target set to element", L), l.on("resize" + b, x.event.resize)
                    },
                    popup: function() {
                    ...
                    close: function() {
                        (!0 === w.hideOnScroll || "auto" == w.hideOnScroll && "click" != w.on) && O.one(x.get.scrollEvent() + b, x.event.hideGracefully), "hover" == w.on && F && (x.verbose("Binding popup close event to document"), s.on("touchstart" + b, function(e) {
                ...
                is: {
                    ...
                    active: function() {
                        return D.hasClass(k.active)
                    },
                    animating: function() {
                        return a !== i && a.hasClass(k.animating)
                    },
                    fluid: function() {
                        return a !== i && a.hasClass(k.fluid)
                    },
                    visible: function() {
                        return a !== i && a.hasClass(k.visible)
                    },
                    dropdown: function() {
                        return D.hasClass(k.dropdown)
                    },
                    hidden: function() {
                        return !x.is.visible()
                    },
                ...
                reset: function() {
                    x.remove.visible(), w.preserve ? e.fn.transition !== i && a.transition("remove transition") : x.removePopup()
                },
                setting: function(t, n) {
                ...
                invoke: function(t, n, o) {
                    var a, s, l, c = I;
                    return n = n || h, o = M || o, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function(n, o) {
                        var r = n != a ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(c[r]) && n != a) c = c[r];
                        else {
                            if (c[r] !== i) return s = c[r], !1;
            ...
            }, g ? (I === i && x.initialize(), x.invoke(p)) : (I !== i && I.invoke("destroy"), x.initialize())
        }), r !== i ? r : this
    }, e.fn.popup.settings = {
        name: "Popup",
        silent: !1,
        ...
        return r.each(function() {
            ...
            f = {
                ...
                read: {
                    ...
                    settings: function() {
                        !1 !== p.total && (f.debug("Current total set in settings", p.total), f.set.total(p.total)), !1 !== p.value && (f.debug("Current value set in settings", p.value), f.set.value(p.value), f.set.progress(f.value)), !1 !== p.percent && (f.debug("Current percent set in settings", p.percent), f.set.percent(p.percent))
                    }
                },
                bind: {
                    transitionEnd: function(e) {
                        ...
                        C.one(t + y, function(t) {
                            ...
                            C.triggerHandler(t)
                        }, p.duration + p.failSafeDelay), f.verbose("Adding fail safe timer", f.timer)
                    }
                },
                increment: function(e) {
                    var t, n;
                    f.has.total() ? (t = f.get.value(), e = e || 1, n = t + e) : (t = f.get.percent(), e = e || f.get.randomValue(), n = t + e, 100, f.debug("Incrementing percentage by", t, n)), n = f.get.normalizedValue(n), f.set.progress(n)
                },
                decrement: function(e) {
                    var t, n;
                    f.get.total() ? (t = f.get.value(), e = e || 1, n = t - e, f.debug("Decrementing value by", e, t)) : (t = f.get.percent(), e = e || f.get.randomValue(), n = t - e, f.debug("Decrementing percentage by", e, t)), n = f.get.normalizedValue(n), f.set.progress(n)
                },
                has: {
                ...
                set: {
                    ...
                    percent: function(e) {
                        e = "string" == typeof e ? +e.replace("%", "") : e, e = p.precision > 0 ? Math.round(e * (10 * p.precision)) / (10 * p.precision) : Math.round(e), f.percent = e, f.has.total() || (f.value = p.precision > 0 ? Math.round(e / 100 * f.total * (10 * p.precision)) / (10 * p.precision) : Math.round(e / 100 * f.total * 10) / 10, p.limitValues && (f.value = f.value > 100 ? 100 : f.value < 0 ? 0 : f.value)), f.set.barWidth(e), f.set.labelInterval(), f.set.labels(), p.onChange.call(S, e, f.value, f.total)
                    },
                    labelInterval: function() {
                        var t = function() {
                            f.verbose("Bar finished animating, removing continuous label updates"), clearInterval(f.interval), E = !1, f.set.labels()
                        };
                        clearInterval(f.interval), f.bind.transitionEnd(t), E = !0, f.interval = setInterval(function() {
                            e.contains(n.documentElement, S) || (clearInterval(f.interval), E = !1), f.set.labels()
                        }, p.framerate)
                    },
                    labels: function() {
                    ...
                    active: function(e) {
                        e = e || p.text.active, f.debug("Setting active state"), p.showActivity && !f.is.active() && w.addClass(g.active), f.remove.warning(), f.remove.error(), f.remove.success(), e = p.onLabelUpdate("active", e, f.value, f.total), e && f.set.label(e), f.bind.transitionEnd(function() {
                            p.onActive.call(S, f.value, f.total)
                        })
                    },
                    success: function(e) {
                        e = e || p.text.success || p.text.active, f.debug("Setting success state"), w.addClass(g.success), f.remove.active(), f.remove.warning(), f.remove.error(), f.complete(), p.text.success ? (e = p.onLabelUpdate("success", e, f.value, f.total), f.set.label(e)) : (e = p.onLabelUpdate("active", e, f.value, f.total), f.set.label(e)), f.bind.transitionEnd(function() {
                            p.onSuccess.call(S, f.total)
                        })
                    },
                    warning: function(e) {
                        e = e || p.text.warning, f.debug("Setting warning state"), w.addClass(g.warning), f.remove.active(), f.remove.success(), f.remove.error(), f.complete(), e = p.onLabelUpdate("warning", e, f.value, f.total), e && f.set.label(e), f.bind.transitionEnd(function() {
                            p.onWarning.call(S, f.value, f.total)
                        })
                    },
                    error: function(e) {
                        e = e || p.text.error, f.debug("Setting error state"), w.addClass(g.error), f.remove.active(), f.remove.success(), f.remove.warning(), f.complete(), e = p.onLabelUpdate("error", e, f.value, f.total), e && f.set.label(e), f.bind.transitionEnd(function() {
                ...
                update: {
                    ...
                    progress: function(e) {
                        var t;
                        e = f.get.numericValue(e), !1 === e && f.error(b.nonNumeric, e), e = f.get.normalizedValue(e), f.has.total() ? (f.set.value(e), t = e / f.total * 100, f.debug("Calculating percent complete from total", t), f.set.percent(t)) : (t = e, f.debug("Setting value to exact percentage value", t), f.set.percent(t))
                    }
                },
                setting: function(t, n) {
                    if (f.debug("Changing setting", t, n), e.isPlainObject(t)) e.extend(!0, p, t);
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.search = function(o) {
        ...
        return e(this).each(function() {
            var p, g = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.search.settings, o) : e.extend({}, e.fn.search.settings),
                h = g.className,
                m = g.metadata,
                v = g.regExp,
                b = g.fields,
            ...
            p = {
                ...
                instantiate: function() {
                    p.verbose("Storing instance of module", p), O = p, T.data(k, p)
                },
                destroy: function() {
                    p.verbose("Destroying instance"), T.off(C).removeData(k)
                },
                refresh: function() {
                    p.debug("Refreshing selector cache"), S = T.find(y.prompt), A = T.find(y.searchButton), D = T.find(y.category), E = T.find(y.results), j = T.find(y.result)
                },
                refreshResults: function() {
                    E = T.find(y.results), j = T.find(y.result)
                },
                bind: {
                    events: function() {
                        p.verbose("Binding events to search"), g.automatic && (T.on(p.get.inputEvent() + C, y.prompt, p.event.input), S.attr("autocomplete", "off")), T.on("focus" + C, y.prompt, p.event.focus).on("blur" + C, y.prompt, p.event.blur).on("keydown" + C, y.prompt, p.handleKeyboard).on("click" + C, y.searchButton, p.query).on("mousedown" + C, y.results, p.event.result.mousedown).on("mouseup" + C, y.results, p.event.result.mouseup).on("click" + C, y.result, p.event.result.click)
                    }
                },
                determine: {
                ...
                event: {
                    input: function() {
                        clearTimeout(p.timer), p.timer = setTimeout(p.query, g.searchDelay)
                    },
                    focus: function() {
                        p.set.focus(), p.has.minimumCharacters() && (p.query(), p.can.show() && p.showResults())
                    },
                    blur: function(e) {
                        var t = n.activeElement === this,
                            i = function() {
                                p.cancel.query(), p.remove.focus(), p.timer = setTimeout(p.hideResults, g.hideDelay)
                            };
                        t || (p.resultsClicked ? (p.debug("Determining if user action caused search to close"), T.one("click.close" + C, y.results, function(e) {
                            return p.is.inMessage(e) || P ? void S.focus() : (P = !1, void(p.is.animating() || p.is.hidden() || i()))
                    ...
                    result: {
                        ...
                        click: function(n) {
                            ...
                            var i = e(this),
                                ...
                                c = p.get.results(),
                                u = i.data(m.result) || p.get.result(l, c);
                            return e.isFunction(g.onSelect) && !1 === g.onSelect.call(R, u, c) ? (p.debug("Custom onSelect callback cancelled default select action"), void(P = !0)) : (p.hideResults(), l && p.set.value(l), void(a && (p.verbose("Opening search link found in result", r), "_blank" == s || n.ctrlKey ? t.open(a) : t.location.href = a)))
                        }
                    }
                },
                ...
                setup: {
                    api: function(t) {
                        ...
                        e.extend(!0, n, g.apiSettings), p.verbose("Setting up API request", n), T.api(n)
                    }
                },
                can: {
                    useAPI: function() {
                ...
                get: {
                    ...
                    results: function() {
                        return T.data(m.results)
                    },
                    result: function(t, n) {
                        var o = ["title", "id"],
                            r = !1;
                        return t = t !== i ? t : p.get.value(), n = n !== i ? n : p.get.results(), "category" === g.type ? (p.debug("Finding result that matches", t), e.each(n, function(n, i) {
                            if (e.isArray(i.results) && (r = p.search.object(t, i.results, o)[0])) return !1
                        })) : (p.debug("Finding result in results object", t), r = p.search.object(t, n, o)[0]), r || !1
                    }
                },
                select: {
                    firstResult: function() {
                        p.verbose("Selecting first result"), j.first().addClass(h.active)
                    }
                },
                set: {
                    focus: function() {
                    ...
                    value: function(e) {
                        p.verbose("Setting search input value", e), S.val(e)
                    },
                    type: function(e) {
                ...
                query: function() {
                    var t = p.get.value(),
                        n = p.read.cache(t);
                    p.has.minimumCharacters() ? (n ? (p.debug("Reading result from cache", t), p.save.results(n.results), p.addResults(n.html), p.inject.id(n.results)) : (p.debug("Querying for", t), e.isPlainObject(g.source) || e.isArray(g.source) ? p.search.local(t) : p.can.useAPI() ? p.search.remote(t) : p.error(x.source)), g.onSearchQuery.call(R, t)) : p.hideResults()
                },
                search: {
                    local: function(e) {
                        var t, n = p.search.object(e, g.content);
                    ...
                    remote: function(e) {
                        T.api("is loading") && T.api("abort"), p.setup.api(e), T.api("query")
                    },
                    object: function(t, n, o) {
                        ...
                        return n = n || g.source, o = o !== i ? o : g.searchFields, e.isArray(o) || (o = [o]), n === i || !1 === n ? (p.error(x.source), []) : (e.each(o, function(i, o) {
                            e.each(n, function(e, n) {
                                "string" == typeof n[o] && (-1 !== n[o].search(l) ? c(r, n) : g.searchFullText && p.fuzzySearch(t, n[o]) && c(a, n))
                            })
                        }), e.merge(r, a))
                    }
                },
                ...
                parse: {
                    response: function(e, t) {
                        ...
                        p.verbose("Parsing server response", e), e !== i && t !== i && e[b.results] !== i && (p.addResults(n), p.inject.id(e[b.results]), p.write.cache(t, {
                            html: n,
                            results: e[b.results]
                ...
                has: {
                    minimumCharacters: function() {
                        return p.get.value().length >= g.minCharacters
                    }
                },
                clear: {
                    cache: function(e) {
                        var t = T.data(m.cache);
                        e ? e && t && t[e] && (p.debug("Removing value from cache", e), delete t[e], T.data(m.cache, t)) : (p.debug("Clearing cache", e), T.removeData(m.cache))
                    }
                },
                read: {
                    cache: function(e) {
                        var t = T.data(m.cache);
                        return !!g.cache && (p.verbose("Checking cache for generated html for query", e), "object" == typeof t && t[e] !== i && t[e])
                    }
                },
                create: {
                    id: function(e, t) {
                ...
                inject: {
                    result: function(e, t, n) {
                        ...
                        p.verbose("Injecting results metadata", o), o.data(m.result, e)
                    },
                    id: function(t) {
                        p.debug("Injecting unique ids into results");
                        var n = 0,
                            o = 0;
                        return "category" === g.type ? e.each(t, function(t, r) {
                            o = 0, e.each(r.results, function(e, t) {
                                var a = r.results[e];
                                a.id === i && (a.id = p.create.id(o, n)), p.inject.result(a, o, n), o++
                            }), n++
                        }) : e.each(t, function(e, n) {
                            var r = t[e];
                            r.id === i && (r.id = p.create.id(o)), p.inject.result(r, o), o++
                        }), t
                    }
                },
                save: {
                    results: function(e) {
                        p.verbose("Saving current search results to metadata", e), T.data(m.results, e)
                    }
                },
                write: {
                    cache: function(e, t) {
                        var n = T.data(m.cache) !== i ? T.data(m.cache) : {};
                        g.cache && (p.verbose("Writing generated html to cache", e, t), n[e] = t, T.data(m.cache, n))
                    }
                },
                addResults: function(t) {
                    return e.isFunction(g.onResultsAdd) && !1 === g.onResultsAdd.call(E, t) ? (p.debug("onResultsAdd callback cancelled default action"), !1) : void(t ? (E.html(t), p.refreshResults(), g.selectFirstResult && p.select.firstResult(), p.showResults()) : p.hideResults())
                },
                showResults: function() {
                    p.is.visible() || (p.can.transition() ? (p.debug("Showing results with css animations"), E.transition({
                        ...
                        duration: g.duration,
                        queue: !0
                    })) : (p.debug("Showing results with javascript"), E.stop().fadeIn(g.duration, g.easing)), g.onResultsOpen.call(E))
                },
                hideResults: function() {
                    p.is.visible() && (p.can.transition() ? (p.debug("Hiding results with css animations"), E.transition({
                        ...
                        duration: g.duration,
                        queue: !0
                    })) : (p.debug("Hiding results with javascript"), E.stop().fadeOut(g.duration, g.easing)), g.onResultsClose.call(E))
                },
                generateResults: function(t) {
                    ...
                    var n = g.templates[g.type],
                        ...
                        r = "";
                    return i || o ? (g.maxResults > 0 && (i ? "standard" == g.type && p.error(x.maxResults) : t[b.results] = t[b.results].slice(0, g.maxResults)), e.isFunction(n) ? r = n(t, b) : p.error(x.noTemplate, !1)) : g.showNoResults && (r = p.displayMessage(x.noResults, "empty")), g.onResults.call(R, t), r
                },
                ...
                invoke: function(t, n, o) {
                    var a, s, l, c = O;
                    return n = n || f, o = R || o, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function(n, o) {
                        var r = n != a ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(c[r]) && n != a) c = c[r];
                        else {
                            if (c[r] !== i) return s = c[r], !1;
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.sidebar = function(o) {
        ...
        return a.each(function() {
            var a, b, y, x, w, C, k = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.sidebar.settings, o) : e.extend({}, e.fn.sidebar.settings),
                ...
                O = e(this),
                P = e(k.context),
                L = O.children(T.sidebar),
                q = P.children(T.fixed),
                N = P.children(T.pusher),
                F = this,
                M = O.data(R);
            C = {
                initialize: function() {
                ...
                instantiate: function() {
                    C.verbose("Storing instance of module", C), M = C, O.data(R, C)
                },
                create: {
                    id: function() {
                ...
                destroy: function() {
                    C.verbose("Destroying previous module for", O), O.off(D).removeData(R), C.is.ios() && C.remove.ios(), P.off(b), s.off(b), l.off(b)
                },
                event: {
                    ...
                    containScroll: function(e) {
                        F.scrollTop <= 0 && (F.scrollTop = 1), F.scrollTop + F.offsetHeight >= F.scrollHeight && (F.scrollTop = F.scrollHeight - F.offsetHeight - 1)
                    },
                    scroll: function(t) {
                ...
                bind: {
                    ...
                    scrollLock: function() {
                        k.scrollLock && (C.debug("Disabling page scroll"), s.on("DOMMouseScroll" + b, C.event.scroll)), C.verbose("Adding events to contain sidebar scroll"), l.on("touchmove" + b, C.event.touch), O.on("scroll" + D, C.event.containScroll)
                    }
                },
                unbind: {
                    clickaway: function() {
                    ...
                    scrollLock: function() {
                        C.verbose("Removing scroll lock from page"), l.off(b), s.off(b), O.off("scroll" + D)
                    }
                },
                add: {
                    inlineCSS: function() {
                ...
                refresh: function() {
                    C.verbose("Refreshing selector cache"), P = e(k.context), L = P.children(T.sidebar), N = P.children(T.pusher), q = P.children(T.fixed), C.clear.cache()
                },
                refreshSidebars: function() {
                    C.verbose("Refreshing other sidebars"), L = P.children(T.sidebar)
                },
                repaint: function() {
                    C.verbose("Forcing repaint event"), F.style.display = "none", F.offsetHeight, F.scrollTop = F.scrollTop, F.style.display = ""
                },
                setup: {
                    cache: function() {
                        C.cache = {
                    ...
                    layout: function() {
                        0 === P.children(T.pusher).length && (C.debug("Adding wrapper element for sidebar"), C.error(j.pusher), N = e('<div class="pusher" />'), P.children().not(T.omitted).not(L).wrapAll(N), C.refresh()), 0 !== O.nextAll(T.pusher).length && O.nextAll(T.pusher)[0] === N[0] || (C.debug("Moved sidebar to correct parent element"), C.error(j.movedSidebar, F), O.detach().prependTo(P), C.refresh()), C.clear.cache(), C.set.pushable(), C.set.direction()
                    }
                },
                attachEvents: function(t, n) {
                    var i = e(t);
                    n = e.isFunction(C[n]) ? C[n] : C.toggle, i.length > 0 ? (C.debug("Attaching sidebar events to element", t, n), i.on("click" + D, n)) : C.error(j.notFound, t)
                },
                show: function(t) {
                    if (t = e.isFunction(t) ? t : function() {}, C.is.hidden()) {
                        if (C.refreshSidebars(), k.overlay && (C.error(j.overlay), k.transition = "overlay"), C.refresh(), C.othersActive())
                        ...
                        C.pushPage(function() {
                            t.call(F), k.onShow.call(F)
                        }), k.onChange.call(F), k.onVisible.call(F)
                ...
                hide: function(t) {
                    t = e.isFunction(t) ? t : function() {}, (C.is.visible() || C.is.animating()) && (C.debug("Hiding sidebar", t), C.refreshSidebars(), C.pullPage(function() {
                        t.call(F), k.onHidden.call(F)
                    }), k.onChange.call(F), k.onHide.call(F))
                },
                othersAnimating: function() {
                    return L.not(O).filter("." + S.animating).length > 0
                },
                othersVisible: function() {
                    return L.not(O).filter("." + S.visible).length > 0
                },
                othersActive: function() {
                    return C.othersVisible() || C.othersAnimating()
                },
                hideOthers: function(e) {
                    var t = L.not(O).filter("." + S.visible),
                        n = t.length,
                        i = 0;
                ...
                pushPage: function(t) {
                    ...
                    t = e.isFunction(t) ? t : function() {}, "scale down" == k.transition && C.scrollToTop(), C.set.transition(r), C.repaint(), n = function() {
                        ...
                        e.target == a[0] && (a.off(w + b, o), C.remove.animating(), C.bind.scrollLock(), t.call(F))
                ...
                pullPage: function(t) {
                    ...
                    t = e.isFunction(t) ? t : function() {}, C.verbose("Removing context push state", C.get.direction()), C.unbind.clickaway(), C.unbind.scrollLock(), n = function() {
                        C.set.transition(o), C.set.animating(), C.remove.visible(), k.dimPage && !C.othersVisible() && N.removeClass(S.dimmed)
                    }, i = function(e) {
                        e.target == r[0] && (r.off(w + b, i), C.remove.animating(), C.remove.transition(), C.remove.inlineCSS(), ("scale down" == o || k.returnScroll && C.is.mobile()) && C.scrollBack(), t.call(F))
                ...
                is: {
                    ...
                    mobile: function() {
                        var e = navigator.userAgent;
                        return e.match(E.mobile) ? (C.verbose("Browser was found to be mobile", e), !0) : (C.verbose("Browser is not mobile, using regular transition", e), !1)
                    },
                    hidden: function() {
                        return !C.is.visible()
                    },
                ...
                invoke: function(t, n, o) {
                    var a, s, l, c = M;
                    return n = n || m, o = F || o, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function(n, o) {
                        var r = n != a ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(c[r]) && n != a) c = c[r];
                        else {
                            if (c[r] !== i) return s = c[r], !1;
                            if (!e.isPlainObject(c[o]) || n == a) return c[o] !== i ? (s = c[o], !1) : (C.error(j.method, t), !1);
                            c = c[o]
                        }
                    })), e.isFunction(s) ? l = s.apply(o, n) : s !== i && (l = s), e.isArray(r) ? r.push(l) : r !== i ? r = [r, l] : l !== i && (r = l), s
                }
            }, h ? (M === i && C.initialize(), C.invoke(g)) : (M !== i && C.invoke("destroy"), C.initialize())
        }), r !== i ? r : this
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.tab = function(o) {
        var r, a = e(e.isFunction(this) ? t : this),
            ...
            p = !1;
        return a.each(function() {
            var g, h, m, v, b, y, x = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.tab.settings, o) : e.extend({}, e.fn.tab.settings),
                w = x.className,
                C = x.metadata,
                k = x.selector,
                T = x.error,
            ...
            b = {
                initialize: function() {
                    b.debug("Initializing tab menu item", E), b.fix.callbacks(), b.determineTabs(), b.debug("Determining tabs", x.context, h), x.auto && b.set.auto(), b.bind.events(), x.history && !p && (b.initializeHistory(), p = !0), b.instantiate()
                },
                instantiate: function() {
                    b.verbose("Storing instance of module", b), P = b, E.data(A, b)
                },
                destroy: function() {
                    b.debug("Destroying tabs", E), E.removeData(A).off(S)
                },
                bind: {
                    events: function() {
                ...
                determineTabs: function() {
                    var t;
                    "parent" === x.context ? (E.closest(k.ui).length > 0 ? (t = E.closest(k.ui), b.verbose("Using closest UI element as parent", t)) : t = E, g = t.parent(), b.verbose("Determined parent element for creating context", g)) : x.context ? (g = e(x.context), b.verbose("Using selector for tab context", x.context, g)) : g = e("body"), x.childrenOnly ? (h = g.children(k.tabs), b.debug("Searching tab context children for tabs", g, h)) : (h = g.find(k.tabs), b.debug("Searching tab context for tabs", g, h))
                },
                fix: {
                    callbacks: function() {
                ...
                initializeHistory: function() {
                    ...
                    if ("state" == x.historyType) {
                        if (b.debug("Using HTML5 to manage state"), !1 === x.path) return b.error(T.path), !1;
                ...
                cache: {
                    ...
                    add: function(e, t) {
                        e = e || m, b.debug("Adding cached content for", e), j[e] = t
                    },
                    remove: function(e) {
                        e = e || m, b.debug("Removing cached content for", e), delete j[e]
                    }
                },
                set: {
                    auto: function() {
                    ...
                    loading: function(e) {
                        ...
                        t.hasClass(w.loading) || (b.verbose("Setting loading state for", t), t.addClass(w.loading).siblings(h).removeClass(w.active + " " + w.loading), t.length > 0 && x.onRequest.call(t[0], e))
                    },
                    state: function(t) {
                        e.address.value(t)
                    }
                ...
                changeTab: function(n) {
                    ...
                    n = b.utilities.arrayToPath(a), e.each(a, function(t, i) {
                        ...
                        if (b.verbose("Looking for tab", i), p) {
                            if (b.verbose("Tab was found", i), m = f, v = b.utilities.filterArray(a, d), h ? u = !0 : (l = a.slice(0, t + 2), c = b.utilities.arrayToPath(l), (u = !b.is.tab(c)) && b.verbose("Tab parameters found", l)), u && r) return o ? (b.debug("Ignoring remote content on first tab load", f), D = !1, b.cache.add(n, k.html()), b.activate.all(f), x.onFirstLoad.call(k[0], f, v, y), x.onLoad.call(k[0], f, v, y)) : (b.activate.navigation(f), b.fetch.content(f, n)), !1;
                            ...
                            if (-1 != n.search("/") || "" === n) return b.error(T.missingTab, E, g, f), !1;
                            if (s = e("#" + n + ', a[name="' + n + '"]'), f = s.closest("[data-tab]").data(C.tab), k = b.get.tabElement(f), s && s.length > 0 && f) return b.debug("Anchor link used, opening parent tab", k, s), k.hasClass(w.active) || setTimeout(function() {
                                b.scrollTo(s)
                ...
                update: {
                    content: function(t, n, o) {
                        var r = b.get.tabElement(t),
                            a = r[0];
                        o = o !== i ? o : x.evaluateScripts, "string" == typeof x.cacheType && "dom" == x.cacheType.toLowerCase() && "string" != typeof n ? r.empty().append(e(n).clone(!0)) : o ? (b.debug("Updating HTML and evaluating inline scripts", t, n), r.html(n)) : (b.debug("Updating HTML", t, n), a.innerHTML = n)
                    }
                },
                fetch: {
                    content: function(t, n) {
                        var o, r, a = b.get.tabElement(t),
                            s = {
                                ...
                                onSuccess: function(e) {
                                    "response" == x.cacheType && b.cache.add(n, e), b.update.content(t, e), t == m ? (b.debug("Content loaded", t), b.activate.tab(t)) : b.debug("Content loaded in background", t), x.onFirstLoad.call(a[0], t, v, y), x.onLoad.call(a[0], t, v, y), "string" == typeof x.cacheType && "dom" == x.cacheType.toLowerCase() && a.children().length > 0 ? setTimeout(function() {
                ...
                activate: {
                    ...
                    tab: function(e) {
                        ...
                        b.verbose("Showing tab content for", t), i || (t.addClass(w.active), n.removeClass(w.active + " " + w.loading), t.length > 0 && x.onVisible.call(t[0], e))
                    },
                    navigation: function(e) {
                        var t = b.get.navElement(e),
                            n = "siblings" == x.deactivate ? t.siblings(a) : a.not(t),
                            i = t.hasClass(w.active);
                        b.verbose("Activating tab navigation for", t, e), i || (t.addClass(w.active), n.removeClass(w.active + " " + w.loading))
                    }
                },
                deactivate: {
                    all: function() {
                ...
                get: {
                    ...
                    defaultPath: function(e) {
                        var t = a.filter("[data-" + C.tab + '^="' + e + '/"]').eq(0),
                            n = t.data(C.tab) || !1;
                        if (n) {
                            if (b.debug("Found default tab", n), R < x.maxDepth) return R++,
                                b.get.defaultPath(n);
                            b.error(T.recursion)
                        } else b.debug("No default tabs found for", e, h);
                        return R = 0, e
                    },
                    navElement: function(e) {
                        return e = e || m, a.filter("[data-" + C.tab + '="' + e + '"]')
                    },
                    tabElement: function(e) {
                        var t, n, i, o;
                        return e = e || m, i = b.utilities.pathToArray(e), o = b.utilities.last(i), t = h.filter("[data-" + C.tab + '="' + e + '"]'), n = h.filter("[data-" + C.tab + '="' + o + '"]'), t.length > 0 ? t : n
                    },
                    tab: function() {
                        return m
                    }
                ...
                utilities: {
                    ...
                    pathToArray: function(e) {
                        return e === i && (e = m), "string" == typeof e ? e.split("/") : [e]
                    },
...
function(e, t, n, i) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.transition = function() {
        ...
        return t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame, r.each(function(t) {
            var p, g, h, m, v, b, y, x, w, C = e(this),
                k = this;
            w = {
                initialize: function() {
                    p = w.get.settings.apply(k, c), m = p.className, h = p.error, v = p.metadata, x = "." + p.namespace, y = "module-" + p.namespace, g = C.data(y) || w, b = w.get.animationEndEvent(), f && (f = w.invoke(u)), !1 === f && (w.verbose("Converted arguments into settings object", p), p.interval ? w.delay(p.animate) : w.animate(), w.instantiate())
                },
                instantiate: function() {
                ...
                delay: function(e) {
                    ...
                    a || (a = w.can.transition() ? w.get.direction() : "static"), e = e !== i ? e : p.interval, n = "auto" == p.reverse && a == m.outward, o = n || 1 == p.reverse ? (r.length - t) * p.interval : t * p.interval, w.debug("Delaying animation by", o), setTimeout(w.animate, o)
                },
                animate: function(e) {
                    if (p = e || p, !w.is.supported()) return w.error(h.support), !1;
                    if (w.debug("Preparing animation", p.animation), w.is.animating()) {
                        ...
                        w.debug("New animation started, completing previous early", p.animation), g.complete()
                    }
                ...
                set: {
                    ...
                    looping: function() {
                        w.debug("Transition set to loop"), C.addClass(m.looping)
                    },
                    hidden: function() {
                        C.addClass(m.transition).addClass(m.hidden)
                    },
                    inward: function() {
                        w.debug("Setting direction to inward"), C.removeClass(m.outward).addClass(m.inward)
                    },
                    outward: function() {
                        w.debug("Setting direction to outward"), C.removeClass(m.inward).addClass(m.outward)
                    },
                    visible: function() {
                        C.addClass(m.transition).addClass(m.visible)
                    }
                },
                start: {
                ...
                remove: {
                    ...
                    direction: function() {
                        C.removeClass(m.inward).removeClass(m.outward)
                    },
                    duration: function() {
                    ...
                    looping: function() {
                        w.debug("Transitions are no longer looping"), w.is.looping() && (w.reset(), C.removeClass(m.looping))
                    },
                    transition: function() {
                        C.removeClass(m.visible).removeClass(m.hidden)
                    }
                },
                get: {
                    ...
                    transition: function(t) {
                        ...
                        if (u === i || t) {
                            if (w.verbose("Determining whether animation exists"), n = C.attr("class"), o = C.prop("tagName"), r = e("<" + o + " />").addClass(n).insertAfter(C), a = r.addClass(c).removeClass(m.inward).removeClass(m.outward).addClass(m.animating).addClass(m.transition).css("animationName"), s = r.addClass(m.inward).css("animationName"), d || (d = r.attr("class", n).removeAttr("style").removeClass(m.hidden).removeClass(m.visible).show().css("display"), w.verbose("Determining final display state", d), w.save.displayType(d)), r.remove(), a != s) w.debug("Direction exists for animation", c), l = !0;
                                ...
                                if ("none" == a || !a) return void w.debug("No animation defined in css", c);
                                w.debug("Static animation found", c, d), l = !1
                            }
                ...
                is: {
                    animating: function() {
                        return C.hasClass(m.animating)
                    },
                    inward: function() {
                        return C.hasClass(m.inward)
                    },
                    outward: function() {
                        return C.hasClass(m.outward)
                    },
                    looping: function() {
                        return C.hasClass(m.looping)
                    },
                ...
                enable: function() {
                    w.verbose("Starting animation"), C.removeClass(m.disabled)
                },
                disable: function() {
                    w.debug("Stopping animation"), C.addClass(m.disabled)
                },
                setting: function(t, n) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.state = function(t) {
        ...
        return r.each(function() {
            ...
            n = {
                ...
                sync: function() {
                    n.verbose("Syncing other buttons to current state"), n.is.active() ? r.not(w).state("activate") : r.not(w).state("deactivate")
                },
                get: {
                    text: function() {
...
function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.i18next = t()
}(this, function() {
    "use strict";
    ...
    function o(e, t, i, o) {
        var r = n(e, t, Object),
            a = r.obj,
            s = r.k;
        a[s] = a[s] || [], o && (a[s] = a[s].concat(i)), o || a[s].push(i)
    }
    ...
    function a(e, t, n) {
        for (var i in t) i in e ? "string" == typeof e[i] || e[i] instanceof String || "string" == typeof t[i] || t[i] instanceof String ? n && (e[i] = t[i]) : a(e[i], t[i], n) : e[i] = t[i];
        return e
    }
    ...
    function d(e) {
        return e = c(e), e.joinArrays = "\n", e
    }

    function f(e) {
        return (e.interpolationPrefix || e.interpolationSuffix || e.escapeInterpolation) && (e = c(e)), e.nsSeparator = e.nsseparator, e.keySeparator = e.keyseparator, e.returnObjects = e.returnObjectTrees, e
    }

    function p(e) {
        e.lng = function() {
            return j.deprecate("i18next.lng() can be replaced by i18next.language for detected language or i18next.languages for languages ordered by translation lookup."), e.services.languageUtils.toResolveHierarchy(e.language)[0]
        }, e.preload = function(t, n) {
            j.deprecate("i18next.preload() can be replaced with i18next.loadLanguages()"), e.loadLanguages(t, n)
        }, e.setLng = function(t, n, i) {
            return j.deprecate("i18next.setLng() can be replaced with i18next.changeLanguage() or i18next.getFixedT() to get a translation function with fixed language or namespace."), "function" == typeof n && (i = n, n = {}), n || (n = {}), !0 === n.fixLng && i ? i(null, e.getFixedT(t)) : void e.changeLanguage(t, i)
        }, e.addPostProcessor = function(t, n) {
            j.deprecate("i18next.addPostProcessor() can be replaced by i18next.use({ type: 'postProcessor', name: 'name', process: fc })"), e.use({
                type: "postProcessor",
                name: t,
                process: n
            })
    ...
    var x = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
        ...
        E = function() {
            function e(t) {
                ...
                w(this, e), this.init(t, n)
            }
            return e.prototype.init = function(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                this.prefix = t.prefix || "i18next:", this.logger = e || A, this.options = t, this.debug = !1 !== t.debug
        ...
        O = function(e) {
            function t() {
                ...
                return o.data = n, o.options = i, o
            }
            return k(t, e), t.prototype.addNamespaces = function(e) {
                ...
                var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                    o = i.keySeparator || this.options.keySeparator;
                void 0 === o && (o = ".");
                var a = [e, t];
                return n && "string" != typeof n && (a = a.concat(n)), n && "string" == typeof n && (a = a.concat(o ? n.split(o) : n)), e.indexOf(".") > -1 && (a = e.split(".")), r(this.data, a)
                ...
                void 0 === a && (a = ".");
                var s = [e, t];
                n && (s = s.concat(a ? n.split(a) : n)), e.indexOf(".") > -1 && (s = e.split("."), o = t, t = s[1]), this.addNamespaces(t), i(this.data, s, o), r.silent || this.emit("added", e, t, n, o)
            }, t.prototype.addResources = function(e, t, n) {
                for (var i in n) "string" == typeof n[i] && this.addResource(e, t, i, n[i], {
                    silent: !0
                });
                this.emit("added", e, t, n)
            }, t.prototype.addResourceBundle = function(e, t, n, o, s) {
                var l = [e, t];
                e.indexOf(".") > -1 && (l = e.split("."), o = n, n = t, t = l[1]), this.addNamespaces(t);
                var c = r(this.data, l) || {};
                o ? a(c, n, s) : c = C({}, c, n), i(this.data, l, c), this.emit("added", e, t, n)
        ...
        L = function(e) {
            function n(i) {
                ...
                return t(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector"], i, r), r.options = o, r.logger = j.create("translator"), r
            }
            return k(n, e), n.prototype.changeLanguage = function(e) {
                e && (this.language = e)
                ...
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                if ("object" !== (void 0 === t ? "undefined" : x(t)) ? t = this.options.overloadTranslationOptionHandler(arguments) : "v1" === this.options.compatibilityAPI && (t = f(t)), void 0 === e || null === e || "" === e) return "";
                ...
                if (s && "cimode" === s.toLowerCase()) {
                    if (l) {
                        return a + (t.nsSeparator || this.options.nsSeparator) + o
                    }
                    return o
                }
                var c = this.resolve(e, t),
                    u = Object.prototype.toString.apply(c),
                    d = ["[object Number]", "[object Function]", "[object RegExp]"],
                    p = void 0 !== t.joinArrays ? t.joinArrays : this.options.joinArrays;
                if (c && "string" != typeof c && d.indexOf(u) < 0 && (!p || "[object Array]" !== u)) {
                    if (!t.returnObjects && !this.options.returnObjects) return this.logger.warn("accessing an object - but returnObjects options is not enabled!"), this.options.returnedObjectHandler ? this.options.returnedObjectHandler(o, c, t) : "key '" + o + " (" + this.language + ")' returned an object instead of string.";
                    if (t.keySeparator || this.options.keySeparator) {
                        var g = "[object Array]" === u ? [] : {};
                        for (var h in c) c.hasOwnProperty(h) && (g[h] = this.translate("" + o + n + h, C({}, t, {
                            joinArrays: !1,
                            ns: r
                        })));
                        c = g
                    }
                } else if (p && "[object Array]" === u)(c = c.join(p)) && (c = this.extendTranslation(c, o, t));
                else {
                    var m = !1,
                        v = !1;
                    if (this.isValidLookup(c) || void 0 === t.defaultValue || (m = !0, c = t.defaultValue), this.isValidLookup(c) || (v = !0, c = o), v || m) {
                        this.logger.log("missingKey", s, a, o, c);
                        var b = [],
                            y = this.languageUtils.getFallbackCodes(this.options.fallbackLng, t.lng || this.language);
                        if ("fallback" === this.options.saveMissingTo && y && y[0])
                            for (var w = 0; w < y.length; w++) b.push(y[w]);
                        ...
                        this.options.saveMissing && (this.options.missingKeyHandler ? this.options.missingKeyHandler(b, a, o, c) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(b, a, o, c)), this.emit("missingKey", b, a, o, c)
                    }
                ...
                return void 0 !== e && a && a.length && !1 !== n.applyPostProcessor && (e = P.handle(a, e, t, n, this)), e
                ...
                return "string" == typeof e && (e = [e]), e.forEach(function(e) {
                    if (!t.isValidLookup(i)) {
                        ...
                        a.forEach(function(e) {
                            t.isValidLookup(i) || c.forEach(function(o) {
                                if (!t.isValidLookup(i)) {
                                    var a = r,
                                        c = [a],
                                        u = void 0;
                                    s && (u = t.pluralResolver.getSuffix(o, n.count)), s && l && c.push(a + u), l && c.push(a += "" + t.options.contextSeparator + n.context), s && c.push(a += u);
                                    for (var d = void 0; d = c.pop();) t.isValidLookup(i) || (i = t.getResource(o, e, d, n))
                                }
                            })
                        })
                    }
        ...
        q = function() {
            function e(t) {
                w(this, e), this.options = t, this.whitelist = this.options.whitelist || !1, this.logger = j.create("languageUtils")
            }
            return e.prototype.getScriptPartFromCode = function(e) {
                ...
                return "string" == typeof e && e.indexOf("-") > -1 ? ("languageOnly" !== this.options.load && r(this.formatLanguageCode(e), !0), "languageOnly" !== this.options.load && "currentOnly" !== this.options.load && r(this.getScriptPartFromCode(e), !0), "currentOnly" !== this.options.load && r(this.getLanguagePartFromCode(e))) : "string" == typeof e && r(this.formatLanguageCode(e)), i.forEach(function(e) {
        ...
        M = function() {
            function e(t) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                w(this, e), this.languageUtils = t, this.options = n, this.logger = j.create("pluralResolver"), this.rules = h()
            }
            return e.prototype.addRule = function(e, t) {
                ...
                var n = this,
                    i = this.getRule(e);
                if (!i) return this.logger.warn("no plural rule found for: " + e), "";
                var o = function() {
                    if (1 === i.numbers.length) return {
                        v: ""
                    };
                    var e = i.noAbs ? i.plurals(t) : i.plurals(Math.abs(t)),
                        o = i.numbers[e];
                    n.options.simplifyPluralSuffix && 2 === i.numbers.length && 1 === i.numbers[0] && (2 === o ? o = "plural" : 1 === o && (o = ""));
                    var r = function() {
                    ...
                    return "v1" === n.options.compatibilityJSON ? 1 === o ? {
                        ...
                        v: r()
                    } : "v2" === n.options.compatibilityJSON || 2 === i.numbers.length && 1 === i.numbers[0] ? {
                        v: r()
                    } : 2 === i.numbers.length && 1 === i.numbers[0] ? {
                        v: r()
                    } : {
                        v: n.options.prepend && e.toString() ? n.options.prepend + e.toString() : e.toString()
                    }
                }();
                return "object" === (void 0 === o ? "undefined" : x(o)) ? o.v : void 0
            }, e
        }(),
        I = function() {
            function t() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                w(this, t), this.logger = j.create("interpolator"), this.init(e, !0)
            }
            return t.prototype.init = function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                arguments[1] && (this.options = e, this.format = e.interpolation && e.interpolation.format || function(e) {
                    return e
                }, this.escape = e.interpolation && e.interpolation.escape || l), e.interpolation || (e.interpolation = {
                    escapeValue: !0
                });
                var t = e.interpolation;
                this.escapeValue = void 0 === t.escapeValue || t.escapeValue, this.prefix = t.prefix ? s(t.prefix) : t.prefixEscaped || "{{", this.suffix = t.suffix ? s(t.suffix) : t.suffixEscaped || "}}", this.formatSeparator = t.formatSeparator ? t.formatSeparator : t.formatSeparator || ",", this.unescapePrefix = t.unescapeSuffix ? "" : t.unescapePrefix || "-", this.unescapeSuffix = this.unescapePrefix ? "" : t.unescapeSuffix || "", this.nestingPrefix = t.nestingPrefix ? s(t.nestingPrefix) : t.nestingPrefixEscaped || s("$t("), this.nestingSuffix = t.nestingSuffix ? s(t.nestingSuffix) : t.nestingSuffixEscaped || s(")"), this.resetRegExp()
            ...
            }, t.prototype.interpolate = function(t, n, i) {
                var o = this,
                    a = void 0,
                    s = void 0,
                    l = function(e) {
                        if (e.indexOf(o.formatSeparator) < 0) return r(n, e);
                        var t = e.split(o.formatSeparator),
                            a = t.shift().trim(),
                            s = t.join(o.formatSeparator).trim();
                        return o.format(r(n, a), s, i)
                    };
                for (this.resetRegExp(); a = this.regexpUnescape.exec(t);) {
                    var c = l(a[1].trim());
                    t = t.replace(a[0], c), this.regexpUnescape.lastIndex = 0
                }
                for (; a = this.regexp.exec(t);) s = l(a[1].trim()), "string" != typeof s && (s = e(s)), s || (this.logger.warn("missed to pass in variable " + a[1] + " for interpolating " + t), s = ""), s = function(e) {
                    return e.replace(/\$/g, "$$$$")
                }(this.escapeValue ? this.escape(s) : s), t = t.replace(a[0], s), this.regexp.lastIndex = 0;
                return t
                ...
                function i(e) {
                    ...
                    e = t.shift();
                    var n = t.join(",");
                    n = this.interpolate(n, s), n = n.replace(/'/g, '"');
                    try {
                        s = JSON.parse(n)
                    } catch (t) {
                ...
                var o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                    ...
                    a = void 0,
                    s = C({}, o);
                for (s.applyPostProcessor = !1; r = this.nestingRegexp.exec(t);) a = n(i.call(this, r[1].trim()), s), "string" != typeof a && (a = e(a)), a || (this.logger.warn("missed to pass in variable " + r[1] + " for interpolating " + t), a = ""), t = t.replace(r[0], a), this.regexp.lastIndex = 0;
                return t
            }, t
        }(),
        H = function(e) {
            function t(n, i, o) {
                ...
                return a.backend = n, a.store = i, a.services = o, a.options = r, a.logger = j.create("backendConnector"), a.state = {}, a.queue = [], a.backend && a.backend.init && a.backend.init(o, r.backend, r), a
            }
            return k(t, e), t.prototype.queueLoad = function(e, t, n) {
                var i = this,
                    o = [],
                    r = [],
                    a = [],
                ...
                return e.forEach(function(e) {
                    ...
                    t.forEach(function(t) {
                        var a = e + "|" + t;
                        i.store.hasResourceBundle(e, t) ? i.state[a] = 2 : i.state[a] < 0 || (1 === i.state[a] ? r.indexOf(a) < 0 && r.push(a) : (i.state[a] = 1, n = !1, r.indexOf(a) < 0 && r.push(a), o.indexOf(a) < 0 && o.push(a), s.indexOf(t) < 0 && s.push(t)))
                    }), n || a.push(e)
                }), (o.length || r.length) && this.queue.push({
                    pending: r,
                    loaded: {},
                    errors: [],
                    callback: n
                ...
                var i = this,
                    ...
                    s = a[0],
                    l = a[1];
                t && this.emit("failedLoading", s, l, t), n && this.store.addResourceBundle(s, l, n), this.state[e] = t ? -1 : 2, this.queue.forEach(function(n) {
                    o(n.loaded, [s], l), m(n.pending, e), t && n.errors.push(t), 0 !== n.pending.length || n.done || (i.emit("loaded", n.loaded), n.errors.length ? n.callback(n.errors) : n.callback(), n.done = !0)
                }), this.queue = this.queue.filter(function(e) {
                    return !e.done
                })
            }, t.prototype.read = function(e, t, n, i, o, r) {
                var a = this;
                return i || (i = 0), o || (o = 250), e.length ? void this.backend[n](e, t, function(s, l) {
                    return s && l && i < 5 ? void setTimeout(function() {
                        a.read.call(a, e, t, n, ++i, 2 * o, r)
                    }, o) : void r(s, l)
                }) : r(null, {})
                ...
                var o = C({}, this.backend.options, this.options.backend);
                "string" == typeof e && (e = this.services.languageUtils.toResolveHierarchy(e)), "string" == typeof t && (t = [t]);
                var a = this.queueLoad(e, t, n);
                return a.toLoad.length ? void(o.allowMultiLoading && this.backend.readMulti ? this.read(a.toLoadLanguages, a.toLoadNamespaces, "readMulti", null, null, function(e, t) {
                    e && i.logger.warn("loading namespaces " + a.toLoadNamespaces.join(", ") + " for languages " + a.toLoadLanguages.join(", ") + " via multiloading failed", e), !e && t && i.logger.log("loaded namespaces " + a.toLoadNamespaces.join(", ") + " for languages " + a.toLoadLanguages.join(", ") + " via multiloading", t), a.toLoad.forEach(function(n) {
                        var o = n.split("|"),
                            a = S(o, 2),
                            s = a[0],
                            l = a[1],
                        ...
                        if (c) i.loaded(n, e, c);
                            ...
                            var u = "loading namespace " + l + " for language " + s + " via multiloading failed";
                            i.loaded(n, u), i.logger.error(u)
                        }
                    })
                }) : function() {
                    var e = function(e) {
                        var t = this,
                            ...
                            o = i[0],
                            r = i[1];
                        this.read(o, r, "read", null, null, function(n, i) {
                            n && t.logger.warn("loading namespace " + r + " for language " + o + " failed", n), !n && i && t.logger.log("loaded namespace " + r + " for language " + o, i), t.loaded(e, n, i)
                        })
                    };
                ...
                var i = C({}, this.backend.options, this.options.backend);
                "string" == typeof e && (e = this.services.languageUtils.toResolveHierarchy(e)), "string" == typeof t && (t = [t]), i.allowMultiLoading && this.backend.readMulti ? this.read(e, t, "readMulti", null, null, function(i, o) {
                    i && n.logger.warn("reloading namespaces " + t.join(", ") + " for languages " + e.join(", ") + " via multiloading failed", i), !i && o && n.logger.log("reloaded namespaces " + t.join(", ") + " for languages " + e.join(", ") + " via multiloading", o), e.forEach(function(e) {
                        t.forEach(function(t) {
                            var a = r(o, [e, t]);
                            if (a) n.loaded(e + "|" + t, i, a);
                            else {
                                var s = "reloading namespace " + t + " for language " + e + " via multiloading failed";
                                n.loaded(e + "|" + t, s), n.logger.error(s)
                            }
                        })
                    })
                }) : function() {
                    var i = function(e) {
                        var t = this,
                            ...
                            r = i[1];
                        this.read(o, r, "read", null, null, function(n, i) {
                            n && t.logger.warn("reloading namespace " + r + " for language " + o + " failed", n), !n && i && t.logger.log("reloaded namespace " + r + " for language " + o, i), t.loaded(e, n, i)
                        })
                    };
                    e.forEach(function(e) {
                        t.forEach(function(t) {
                ...
                this.backend && this.backend.create && this.backend.create(e, t, n, i), e && e[0] && this.store.addResource(e[0], t, n, i)
            }, t
        }(D),
        $ = function(e) {
            function t(n, i, o) {
                ...
                w(this, t);
                var a = T(this, e.call(this));
                return a.cache = n, a.store = i, a.services = o, a.options = r, a.logger = j.create("cacheConnector"), a.cache && a.cache.init && a.cache.init(o, r.cache, r), a
            }
            return k(t, e), t.prototype.load = function(e, t, n) {
                var i = this;
                ...
                "string" == typeof e && (e = this.services.languageUtils.toResolveHierarchy(e)), "string" == typeof t && (t = [t]), o.enabled ? this.cache.load(e, function(t, o) {
                    if (t && i.logger.error("loading languages " + e.join(", ") + " from cache failed", t), o)
                        for (var r in o)
                            for (var a in o[r])
                                if ("i18nStamp" !== a) {
                                    var s = o[r][a];
                                    s && i.store.addResourceBundle(r, a, s)
                                } n && n()
                }) : n && n()
    ...
    return new(function(e) {
        function t() {
            ...
            w(this, t);
            var o = T(this, e.call(this));
            if (o.options = b(n), o.services = {}, o.logger = j, o.modules = {
                    external: []
                }, i && !o.isInitialized && !n.isClone) {
                var r;
                if (!o.options.initImmediate) return r = o.init(n, i), T(o, r);
                setTimeout(function() {
                    o.init(n, i)
                }, 0)
            }
        ...
        return k(t, e), t.prototype.init = function(e, t) {
            function n(e) {
                if (e) return "function" == typeof e ? new e : e
            }
            var i = this;
            if ("function" == typeof e && (t = e, e = {}), e || (e = {}), "v1" === e.compatibilityAPI ? this.options = C({}, v(), b(u(e)), {}) : "v1" === e.compatibilityJSON ? this.options = C({}, v(), b(d(e)), {}) : this.options = C({}, v(), this.options, b(e)), t || (t = y), !this.options.isClone) {
                this.modules.logger ? j.init(n(this.modules.logger), this.options) : j.init(null, this.options);
                var o = new q(this.options);
                this.store = new O(this.options.resources, this.options);
                var r = this.services;
                r.logger = j, r.resourceStore = this.store, r.resourceStore.on("added removed", function(e, t) {
                    r.cacheConnector.save()
                }), r.languageUtils = o, r.pluralResolver = new M(o, {
                    prepend: this.options.pluralSeparator,
                    compatibilityJSON: this.options.compatibilityJSON,
                    simplifyPluralSuffix: this.options.simplifyPluralSuffix
                }), r.interpolator = new I(this.options), r.backendConnector = new H(n(this.modules.backend), r.resourceStore, r, this.options), r.backendConnector.on("*", function(e) {
                    for (var t = arguments.length, n = Array(t > 1 ? t - 1 : 0), o = 1; o < t; o++) n[o - 1] = arguments[o];
                    i.emit.apply(i, [e].concat(n))
                }), r.backendConnector.on("loaded", function(e) {
                    r.cacheConnector.save()
                }), r.cacheConnector = new $(n(this.modules.cache), r.resourceStore, r, this.options), r.cacheConnector.on("*", function(e) {
                    for (var t = arguments.length, n = Array(t > 1 ? t - 1 : 0), o = 1; o < t; o++) n[o - 1] = arguments[o];
                    i.emit.apply(i, [e].concat(n))
                }), this.modules.languageDetector && (r.languageDetector = n(this.modules.languageDetector), r.languageDetector.init(r, this.options.detection, this.options)), this.translator = new L(this.services, this.options), this.translator.on("*", function(e) {
                    for (var t = arguments.length, n = Array(t > 1 ? t - 1 : 0), o = 1; o < t; o++) n[o - 1] = arguments[o];
                    i.emit.apply(i, [e].concat(n))
            ...
            }), "v1" === this.options.compatibilityAPI && p(this);
            var a = function() {
                i.changeLanguage(i.options.lng, function(e, n) {
                    i.isInitialized = !0, i.logger.log("initialized", i.options), i.emit("initialized", i.options), t(e, n)
                })
            };
            ...
            if (this.options.resources) t(null);
                ...
                var n = function() {
                    ...
                    if (e.language) i(e.language);
                    else {
                        e.services.languageUtils.getFallbackCodes(e.options.fallbackLng).forEach(function(e) {
                            return i(e)
                        })
                    }
                ...
                if ("object" === (void 0 === n ? "undefined" : x(n))) return n.v
            }
            ...
            return "backend" === e.type && (this.modules.backend = e), "cache" === e.type && (this.modules.cache = e), ("logger" === e.type || e.log && e.warn && e.error) && (this.modules.logger = e), "languageDetector" === e.type && (this.modules.languageDetector = e), "postProcessor" === e.type && P.addPostProcessor(e), "3rdParty" === e.type && this.modules.external.push(e), this
...
function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.i18nextXHRBackend = t()
}(this, function() {
    "use strict";
    ...
    function n(e, n, i, o, r) {
        o && "object" === (void 0 === o ? "undefined" : l(o)) && (r || (o._t = new Date), o = t("", o).slice(1)), n.queryStringParams && (e = t(e, n.queryStringParams));
        try {
            var a;
            ...
            a.onreadystatechange = function() {
                a.readyState > 3 && i && i(a.responseText, a)
            }, a.send(o)
        } catch (e) {
    ...
    var r = [],
        ...
        u = function() {
            function t(e) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                i(this, t), this.init(e, n), this.type = "backend"
            }
            return c(t, [{
                key: "init",
                value: function(t) {
                    var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    this.services = t, this.options = e(n, this.options || {}, o())
                }
            }, {
                key: "readMulti",
                value: function(e, t, n) {
...
var keyPlurals = {
        ...
        "<b>{{ months }}</b> month costs <b>€ {{ eur }}</b>": "<b>{{ months }}</b> months cost <b>€ {{ eur }}</b>"
    },
    singlePageSnippets = {
        "/2fa_gateway": function() {
            $("#telegram-code").on("input", function() {
                $(this).val().length >= 6 ? $.get("/2fa_gateway/verify", {
                    token: $(this).val().trim().substr(0, 8)
                }, function(e) {
                    switch (e) {
                        case "0":
                            $("#telegram-code").closest(".field").addClass("success"), redir = redir || "/", window.location.href = redir;
                            break;
                        case "1":
        ...
        "/leaderboard": function() {
            function e() {
                ...
                window.history.replaceState("", document.title, e.pathname + "?mode=" + favouriteMode + "&p=" + page + "&rx=" + rx + ("" != country ? "&country=" + encodeURI(country) : "") + e.hash), api("leaderboard", {
                    mode: favouriteMode,
                    p: page,
                    l: 50,
                    rx: rx,
                    ...
                    n.find("tr").remove(), null == e.users && (disableSimplepagButtons(!0), e.users = []);
                    var i = 0;
                    e.users.forEach(function(e) {
                        n.append($("<tr />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/u/" + e.id + "' title='View profile'><i class='" + e.country.toLowerCase() + " flag'></i>" + escapeHTML(e.username) + "</a>"), $("<td />").html(t(e.chosen_mode.ranked_score, e.chosen_mode.pp)), $("<td />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), $("<td />").html(addCommas(e.chosen_mode.playcount) + " <i title='" + T("Why, LOVE, of course!") + "'>(lv. " + e.chosen_mode.level.toFixed(0) + ")</i>")))
                    }), disableSimplepagButtons(e.users.length < 50)
                })
            }
            ...
            page = 0 === page ? 1 : page, $("#country-chooser-modal").click(function() {
                $(".ui.modal").modal("show")
            }), $(".lb-country").click(function() {
                country = $(this).data("country"), page = 1, $(".ui.modal").modal("hide"), e()
            }), e(), setupSimplepag(e), $("#mode-menu .item").click(function(t) {
                t.preventDefault(), $("#mode-menu .active.item").removeClass("active"), $(this).addClass("active"), favouriteMode = $(this).data("mode"), country = "", page = 1, e()
            }), $("#rx-menu .item").click(function(t) {
                t.preventDefault(), $("#rx-menu .active.item").removeClass("active"), $(this).addClass("active"), rx = $(this).data("rx"), country = "", page = 1, e()
            })
        },
        "/friends": function() {
            $(".smalltext.button").click(function() {
                var e = $(this),
                    t = "1" === e.data("deleted") ? "add" : "del";
                console.log(t), e.addClass("disabled"), api("friends/" + t, {
                    user: +e.data("userid")
                }, function(t) {
                    e.removeClass("disabled"), e.data("deleted", t.friend ? "0" : "1"), e.removeClass("green red blue"), e.addClass(t.friend ? t.mutual ? "red" : "green" : "blue"), e.find(".icon").removeClass("minus plus heart").addClass(t.friend ? t.mutual ? "heart" : "minus" : "plus"), e.find("span").text(t.friend ? T(t.mutual ? "Mutual" : "Remove") : e("Add"))
                }, !0)
            })
        },
        "/team": function() {
        ...
        "/register/verify": function() {
            ...
            setInterval(function() {
                $.getJSON(hanayoConf.banchoAPI + "/api/v1/verifiedStatus?u=" + e, function(t) {
                    t.result >= 0 && (window.location.href = "/register/welcome?u=" + e)
                })
            }, 5e3)
        },
        "/settings": function() {
            $("input[name='custom_badge.icon']").on("input", function() {
                ...
                $(this).is(":checked") ? $("#custom-badge-fields").slideDown() : $("#custom-badge-fields").slideUp()
            });
            var e = $("#dark-site").is(":checked");
            $("form").submit(function(t) {
                t.preventDefault();
                var n = $("#dark-site").is(":checked");
                if (n != e) {
                    var i = document.cookie.replace(/(?:(?:^|.*;\s*)cflags\s*\=\s*([^;]*).*$)|^.*$/, "$1");
                    i = n ? 1 | +i : -2 & +i, document.cookie = "cflags=" + i + ";path=/;max-age=31536000"
                }
                var o = formToObject($(this)),
                    r = 0;
                $(this).find("input[data-sv]").each(function(e, t) {
                    t = $(t), t.is(":checked") && (r |= t.data("sv"))
                }), o.play_style = r;
                var a = $(this);
                return api("users/self/settings", o, function(t) {
                    if (n != e) return void window.location.reload();
                    showMessage("success", "Your new settings have been saved."), a.removeClass("loading")
                }, !0), !1
            })
        },
        "/settings/userpage": function() {
            ...
            $("textarea[name='data']").on("input", function() {
                ...
                $(this).val();
                e = setTimeout(function() {
                    $("#userpage-content").addClass("loading"), $.post("/settings/userpage/parse", $("textarea[name='data']").val(), function(e) {
                        var t = $("#userpage-content").removeClass("loading").html(e);
                        "undefined" != typeof twemoji && twemoji.parse(t[0])
                    }, "text")
                }, 800)
            }), $("form").submit(function(e) {
                e.preventDefault();
                var t = formToObject($(this)),
                    n = $(this);
                return api("users/self/userpage", t, function(e) {
                    showMessage("success", "Your userpage has been saved."), n.removeClass("loading")
                }, !0), !1
            })
        },
        "/donate": function() {
            var e = $("#months-slider")[0];
            noUiSlider.create(e, {
                start: [1],
                step: 1,
                connect: [!0, !1],
            ...
            var t = {},
                n = e.noUiSlider;
            $.getJSON("/donate/rates", function(e) {
                t = e, n.on("update", function() {
                    var e = n.get(),
                        i = Math.pow(30 * e * .2, .7),
                        o = i / t.EUR,
                        r = o * t.USD;
                    $("#cost").html(T("<b>{{ months }}</b> month costs <b>€ {{ eur }}</b>", {
                        count: Math.round(+e),
                        months: (+e).toFixed(0),
                        eur: i.toFixed(2)
                    }) + "<br>" + T("($ {{ usd }})", {
                        usd: r.toFixed(2)
                    })), $("input[name='os0']").attr("value", (+e).toFixed(0) + " month" + (1 == e ? "" : "s")), $("#paypal-amt").val(i.toFixed(2))
                })
        ...
        "/settings/avatar": function() {
            $("#file").change(function(e) {
                ...
                if (!(t.length < 1)) {
                    var n = window.URL.createObjectURL(t[0]),
                        i = $("#avatar-img")[0];
        ...
        "/beatmaps/rank_request": function() {
            function e(e) {
                $("#queue-info").html(e.submitted + "/" + e.queue_size), 0 == e.submitted_by_user ? $("#by-you").attr("hidden", "hidden") : $("#by-you").removeAttr("hidden"), $("#submitted-by-user").text(e.submitted_by_user), $("#max-per-user").text(e.max_per_user);
                var t = (e.submitted / e.queue_size * 100).toFixed(0);
                $("#progressbar .progress").text(t + "%"), $("#progressbar").progress({
                    percent: t
                }), e.can_submit ? $("#b-form .input, #b-form .button").removeClass("disabled") : $("#b-form .input, #b-form .button").addClass("disabled")
            }
            setInterval(function() {
                api("beatmaps/rank_requests/status", {}, e)
            }, 1e4);
            var t = /^https?:\/\/osu.ppy.sh\/(s|b)\/(\d+)$/gi;
            $("#b-form").submit(function(n) {
                n.preventDefault();
                var i = $("#beatmap").val().trim(),
                    o = t.exec(i);
                if (t.exec(), console.log(i, o), null === o) return showMessage("error", "Please provide a valid link, in the form of either https://osu.ppy.sh/s/&lt;ID&gt; or https://osu.ppy.sh/b/&lt;ID&gt;."), $(this).removeClass("loading"), !1;
                var r = {};
                "s" == o[1] ? r.set_id = +o[2] : r.id = +o[2];
                var a = $(this);
                return api("beatmaps/rank_requests", r, function(t) {
                    a.removeClass("loading"), showMessage("success", "Beatmap rank request has been submitted."), e(t)
                }, function(e) {
                    a.removeClass("loading"), 406 == e.code && showMessage("warning", "That beatmap is already ranked!")
                }, !0), !1
            })
        },
        "/settings/profbackground": function() {
            $("#colorpicker").minicolors({
                ...
                $("[data-type]:not([hidden])").attr("hidden", "hidden"), $("[data-type=" + $(this).val() + "]").removeAttr("hidden")
            }), $("#file").change(function(e) {
                var t = e.target.files;
                if (!(t.length < 1)) {
                    var n = window.URL.createObjectURL(t[0]),
...
$(document).ready(function() {
    $(".message .close").on("click", closeClosestMessage), $(".ui.checkbox").checkbox(), $(".ui.dropdown").dropdown(), $(".ui.progress").progress(), $(".ui.form").submit(function(e) {
        var t = $(this);
        if (t.hasClass("loading") || t.hasClass("disabled")) return e.preventDefault(), !1;
        t.addClass("loading");
        var n = t.attr("id");
        $("[form='" + n + "']").addClass("loading")
    }), "undefined" != typeof twemoji && $(".twemoji").each(function(e, t) {
        twemoji.parse(t)
    });
    var e = singlePageSnippets[window.location.pathname];
    "function" == typeof e && e(), "function" == typeof deferredToPageLoad && deferredToPageLoad(), $("#user-search").search({
        onSelect: function(e) {
            return window.location.href = e.url, !1
        },
        apiSettings: {
            ...
            onResponse: function(e) {
                ...
                return $.each(e.users, function(e, n) {
                    t.results.push({
                        title: n.username,
                        url: "/u/" + n.id,
                        image: hanayoConf.avatars + "/" + n.id
                    })
                }), t
            }
        }
    }), $("#user-search-input").keypress(function(e) {
        13 == e.which && (window.location.pathname = "/u/" + $(this).val())
    }), $(document).keydown(function(e) {
        var t = $(document.activeElement),
            n = t.is(":input,[contenteditable]");
        83 !== e.which && 115 !== e.which || n || ($("#user-search-input").focus(), e.preventDefault()), 27 === e.which && n && t.blur()
    }), $.timeago.settings.allowFuture = !0, $("time.timeago").timeago(), $("#language-selector .item").click(function() {
        var e = $(this).data("lang");
        document.cookie = "language=" + e + ";path=/;max-age=31536000", window.location.reload()
    }), isLoggedIn() && banchoAPI("clients/" + currentUserID, {}, function(e) {
        var t = "offline";
        e.clients.forEach(function(e) {
            0 === e.type ? t = "online" : 1 === e.type && "online" !== t && (t = "irc")
        }), $("#avatar").addClass(t)
    })
});
var modes = {
...
var modsString = ["NF", "EZ", "NV", "HD", "HR", "SD", "DT", "RX", "HT", "NC", "FL", "AU", "SO", "AP", "PF", "K4", "K5", "K6", "K7", "K8", "K9", "RN", "LM", "K9", "K0", "K1", "K3", "K2"],
    langWhitelist = ["de", "it", "ko", "es", "ru", "pl", "fr", "nl", "sv", "fi", "ro", "ko", "vi"];
...
var i18nLoaded = -1 === $.inArray(hanayoConf.language, langWhitelist);
i18next.on("loaded", function() {
    i18nLoaded = !0
});
var apiPrivileges = ["ReadConfidential", "Write", "ManageBadges", "BetaKeys", "ManageSettings", "ViewUserAdvanced", "ManageUser", "ManageRoles", "ManageAPIKeys", "Blog", "APIMeta", "Beatmap", "Bancho"];
